...
@executeFirstLayer1_p = internal unnamed_addr constant [22 x i8] c"executeFirstLayer1_p2\00"
...
for.header.i.i:                                   ; preds = %0, %._crit_edge.i.i
  ...
  %indvar59_reg2mem71 = phi i5 [ 0, %0 ], [ %p_reg2mem31_0_i_i_mid, %._crit_edge.i.i ]
  %indvar_reg2mem69_0_i = phi i6 [ 0, %0 ], [ %indvar_inc_reg2mem, %._crit_edge.i.i ]
...
for.body58.i.i:                                   ; preds = %for.header.i.i
  ...
  %tmp_9 = icmp eq i6 %indvar_reg2mem69_0_i, -32
  %indvar_reg2mem69_0_i_1 = select i1 %tmp_9, i6 0, i6 %indvar_reg2mem69_0_i
  %indvar_inc60_reg2mem = add i5 %indvar59_reg2mem71, 1
  %p_reg2mem31_0_i_i_mid = select i1 %tmp_9, i5 %indvar_inc60_reg2mem, i5 %indvar59_reg2mem71
  %p_reg2mem31_0_i_i_mid_1 = zext i5 %p_reg2mem31_0_i_i_mid to i16
  %p_reg2mem31_0_i_i_mid_2 = mul i16 %p_reg2mem31_0_i_i_mid_1, 2724
  %tmp_cast_mid2_v = or i16 %p_reg2mem31_0_i_i_mid_2, 1
  %tmp_cast_mid2 = zext i16 %tmp_cast_mid2_v to i17
  %tmp_1_cast_mid2_v = or i16 %p_reg2mem31_0_i_i_mid_2, 2
  %tmp_1_cast_mid2 = zext i16 %tmp_1_cast_mid2_v to i17
  %tmp_28_mid2_v_v = zext i5 %p_reg2mem31_0_i_i_mid to i12
  %tmp_28_mid2_v = mul i12 %tmp_28_mid2_v_v, 55
  %tmp_28_mid2 = zext i12 %tmp_28_mid2_v to i30
  %empty_5 = call i32 (...)* @_ssdm_op_SpecLoopName([13 x i8]* @XCL_WG_DIM_X_str) nounwind
  %col_0_reg2mem_0_i_i = xor i6 %indvar_reg2mem69_0_i_1, -32
  %p_shl = call i10 @_ssdm_op_BitConcatenate.i10.i6.i4(i6 %col_0_reg2mem_0_i_i, i4 0)
  %p_shl1 = call i8 @_ssdm_op_BitConcatenate.i8.i6.i2(i6 %col_0_reg2mem_0_i_i, i2 0)
  %p_shl1_cast = zext i8 %p_shl1 to i10
  %p_reg2mem27_0_i_i = sub i10 %p_shl, %p_shl1_cast
  %p_reg2mem27_0_i_i_cas = zext i10 %p_reg2mem27_0_i_i to i17
  %p_reg2mem27_0_i_i_cas_1 = zext i10 %p_reg2mem27_0_i_i to i16
  %tmp = add i16 %p_reg2mem27_0_i_i_cas_1, %p_reg2mem31_0_i_i_mid_2
  %tmp_cast = zext i16 %tmp to i17
  %tmp3 = add i17 %p_reg2mem27_0_i_i_cas, %tmp_cast_mid2
  %tmp7 = add i17 %p_reg2mem27_0_i_i_cas, %tmp_1_cast_mid2
  br label %.loopexit
...
; <label>:1                                       ; preds = %.preheader
  ...
  %tmp1_cast = sext i14 %tmp1 to i17
  %tmp_19 = add i17 %tmp_cast, %tmp1_cast
  %gep_idx20_i_i_cast = zext i17 %tmp_19 to i31
  ...
  %tmp_24 = add i17 %tmp3, %tmp1_cast
  %gep_idx36_i_i_cast = zext i17 %tmp_24 to i31
  ...
  %tmp_30 = add i17 %tmp7, %tmp1_cast
  %gep_idx52_i_i_cast = zext i17 %tmp_30 to i31
...
._crit_edge.i.i:                                  ; preds = %.loopexit
  ...
  %tmp_13 = zext i6 %col_0_reg2mem_0_i_i to i30
  ...
  %indvar_inc_reg2mem = add i6 1, %indvar_reg2mem69_0_i_1
  br label %for.header.i.i
...
entry:
  ...
  %empty_10 = zext i2 %1 to i8
  %empty_11 = shl i8 %empty, 2
...
entry:
  ...
  %empty_13 = zext i2 %1 to i6
  %empty_14 = shl i6 %empty, 2
