; ModuleID = 'C:/Users/RA_prof_Jeon/siddharth/layer1_con_p2/solution1/.autopilot/db/a.o.3.bc'
target datalayout = "e-p:32:32:32-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v16:16:16-v24:32:32-v32:32:32-v48:64:64-v64:64:64-v96:128:128-v128:128:128-v192:256:256-v256:256:256-v512:512:512-v1024:1024:1024"
target triple = "spir-unknown-linux-gnu"

@executeFirstLayer1_p = internal unnamed_addr constant [22 x i8] c"executeFirstLayer1_p2\00" ; [#uses=1 type=[22 x i8]*]
...
; [#uses=0]
define void @executeFirstLayer1_p2(i32 addrspace(1)* %gmem, i32* %group_id_x, i32* %group_id_y, i32* %group_id_z, i32* %bias, i32* %Layer1_Neurons_GPU, i32* %Layer1_Weights_GPU, i32* %Layer2_Neurons_GPU) {
...
for.header.i.i:                                   ; preds = %._crit_edge.i.i, %0
  ...
  %indvar59_reg2mem71 = phi i5 [ 0, %0 ], [ %p_reg2mem31_0_i_i_mid, %._crit_edge.i.i ] ; [#uses=2 type=i5]
  %indvar_reg2mem69_0_i = phi i6 [ 0, %0 ], [ %indvar_inc_reg2mem, %._crit_edge.i.i ] ; [#uses=2 type=i6]
...
for.body58.i.i:                                   ; preds = %for.header.i.i
  ...
  %tmp_9 = icmp eq i6 %indvar_reg2mem69_0_i, -32  ; [#uses=2 type=i1]
  %indvar_reg2mem69_0_i_1 = select i1 %tmp_9, i6 0, i6 %indvar_reg2mem69_0_i ; [#uses=2 type=i6]
  %indvar_inc60_reg2mem = add i5 %indvar59_reg2mem71, 1 ; [#uses=1 type=i5]
  %p_reg2mem31_0_i_i_mid = select i1 %tmp_9, i5 %indvar_inc60_reg2mem, i5 %indvar59_reg2mem71, !dbg !208 ; [#uses=3 type=i5] [debug line = 17:5]
  %p_reg2mem31_0_i_i_mid_1 = zext i5 %p_reg2mem31_0_i_i_mid to i16, !dbg !208 ; [#uses=1 type=i16] [debug line = 17:5]
  %p_reg2mem31_0_i_i_mid_2 = mul i16 %p_reg2mem31_0_i_i_mid_1, 2724, !dbg !208 ; [#uses=3 type=i16] [debug line = 17:5]
  %tmp_cast_mid2_v = or i16 %p_reg2mem31_0_i_i_mid_2, 1, !dbg !195 ; [#uses=1 type=i16] [debug line = 26:13]
  %tmp_cast_mid2 = zext i16 %tmp_cast_mid2_v to i17, !dbg !195 ; [#uses=1 type=i17] [debug line = 26:13]
  %tmp_1_cast_mid2_v = or i16 %p_reg2mem31_0_i_i_mid_2, 2, !dbg !195 ; [#uses=1 type=i16] [debug line = 26:13]
  %tmp_1_cast_mid2 = zext i16 %tmp_1_cast_mid2_v to i17, !dbg !195 ; [#uses=1 type=i17] [debug line = 26:13]
  %tmp_28_mid2_v_v = zext i5 %p_reg2mem31_0_i_i_mid to i12, !dbg !207 ; [#uses=1 type=i12] [debug line = 34:5]
  %tmp_28_mid2_v = mul i12 %tmp_28_mid2_v_v, 55, !dbg !207 ; [#uses=1 type=i12] [debug line = 34:5]
  %tmp_28_mid2 = zext i12 %tmp_28_mid2_v to i30, !dbg !207 ; [#uses=1 type=i30] [debug line = 34:5]
  %empty_5 = call i32 (...)* @_ssdm_op_SpecLoopName([13 x i8]* @XCL_WG_DIM_X_str) nounwind ; [#uses=0 type=i32]
  %col_0_reg2mem_0_i_i = xor i6 %indvar_reg2mem69_0_i_1, -32, !dbg !209 ; [#uses=3 type=i6] [debug line = 15:15]
  %p_shl = call i10 @_ssdm_op_BitConcatenate.i10.i6.i4(i6 %col_0_reg2mem_0_i_i, i4 0), !dbg !210 ; [#uses=1 type=i10] [debug line = 20:5]
  %p_shl1 = call i8 @_ssdm_op_BitConcatenate.i8.i6.i2(i6 %col_0_reg2mem_0_i_i, i2 0), !dbg !210 ; [#uses=1 type=i8] [debug line = 20:5]
  %p_shl1_cast = zext i8 %p_shl1 to i10, !dbg !210 ; [#uses=1 type=i10] [debug line = 20:5]
  %p_reg2mem27_0_i_i = sub i10 %p_shl, %p_shl1_cast, !dbg !210 ; [#uses=2 type=i10] [debug line = 20:5]
  %p_reg2mem27_0_i_i_cas = zext i10 %p_reg2mem27_0_i_i to i17, !dbg !210 ; [#uses=2 type=i17] [debug line = 20:5]
  %p_reg2mem27_0_i_i_cas_1 = zext i10 %p_reg2mem27_0_i_i to i16, !dbg !210 ; [#uses=1 type=i16] [debug line = 20:5]
  %tmp = add i16 %p_reg2mem27_0_i_i_cas_1, %p_reg2mem31_0_i_i_mid_2, !dbg !195 ; [#uses=1 type=i16] [debug line = 26:13]
  %tmp_cast = zext i16 %tmp to i17, !dbg !195     ; [#uses=1 type=i17] [debug line = 26:13]
  %tmp3 = add i17 %p_reg2mem27_0_i_i_cas, %tmp_cast_mid2, !dbg !195 ; [#uses=1 type=i17] [debug line = 26:13]
  %tmp7 = add i17 %p_reg2mem27_0_i_i_cas, %tmp_1_cast_mid2, !dbg !195 ; [#uses=1 type=i17] [debug line = 26:13]
  br label %.loopexit, !dbg !211                  ; [debug line = 22:18]
...
.loopexit:                                        ; preds = %.loopexit.loopexit, %for.body58.i.i
  ...
  %exitcond5 = icmp eq i4 %i_0_reg2mem47_0_i_i, -5, !dbg !211 ; [#uses=1 type=i1] [debug line = 22:18]
  %empty_6 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 11, i64 11, i64 11) ; [#uses=0 type=i32]
  %p_reg2mem5_0_i_i = add i4 %i_0_reg2mem47_0_i_i, 1, !dbg !212 ; [#uses=1 type=i4] [debug line = 22:28]
  br i1 %exitcond5, label %._crit_edge.i.i, label %.preheader.preheader, !dbg !211 ; [debug line = 22:18]
...
.preheader.preheader:                             ; preds = %.loopexit
  ...
  br label %.preheader, !dbg !213                 ; [debug line = 24:22]
...
.preheader:                                       ; preds = %1, %.preheader.preheader
  ...
  %j_0_reg2mem43_0_i_i_s = zext i4 %j_0_reg2mem43_0_i_i to i8, !dbg !213 ; [#uses=1 type=i8] [debug line = 24:22]
  %j_0_reg2mem43_0_i_i_1 = zext i4 %j_0_reg2mem43_0_i_i to i5, !dbg !213 ; [#uses=1 type=i5] [debug line = 24:22]
  %j_0_reg2mem43_0_i_i_2 = zext i4 %j_0_reg2mem43_0_i_i to i7, !dbg !213 ; [#uses=2 type=i7] [debug line = 24:22]
  %exitcond = icmp eq i4 %j_0_reg2mem43_0_i_i, -5, !dbg !213 ; [#uses=1 type=i1] [debug line = 24:22]
  %empty_7 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 11, i64 11, i64 11) ; [#uses=0 type=i32]
  %p_reg2mem7_0_i_i = add i4 %j_0_reg2mem43_0_i_i, 1, !dbg !214 ; [#uses=1 type=i4] [debug line = 24:32]
  br i1 %exitcond, label %.loopexit.loopexit, label %1, !dbg !213 ; [debug line = 24:22]

; <label>:1                                       ; preds = %.preheader
  %p_shl2 = call i6 @_ssdm_op_BitConcatenate.i6.i4.i2(i4 %j_0_reg2mem43_0_i_i, i2 0), !dbg !195 ; [#uses=1 type=i6] [debug line = 26:13]
  %p_shl2_cast = zext i6 %p_shl2 to i7, !dbg !195 ; [#uses=1 type=i7] [debug line = 26:13]
  %tmp_18 = sub i7 %p_shl2_cast, %j_0_reg2mem43_0_i_i_2, !dbg !195 ; [#uses=1 type=i7] [debug line = 26:13]
  %tmp_18_cast = sext i7 %tmp_18 to i14, !dbg !195 ; [#uses=1 type=i14] [debug line = 26:13]
  %tmp1 = add i14 %tmp_18_cast, %phi_mul_cast, !dbg !195 ; [#uses=1 type=i14] [debug line = 26:13]
  %tmp1_cast = sext i14 %tmp1 to i17, !dbg !195   ; [#uses=3 type=i17] [debug line = 26:13]
  %tmp_19 = add i17 %tmp_cast, %tmp1_cast, !dbg !195 ; [#uses=1 type=i17] [debug line = 26:13]
  %gep_idx20_i_i_cast = zext i17 %tmp_19 to i31   ; [#uses=1 type=i31]
  ...
  %tmp2 = add i7 %j_0_reg2mem43_0_i_i_2, %phi_mul2, !dbg !195 ; [#uses=1 type=i7] [debug line = 26:13]
  ...
  %tmp_24 = add i17 %tmp3, %tmp1_cast, !dbg !195  ; [#uses=1 type=i17] [debug line = 26:13]
  %gep_idx36_i_i_cast = zext i17 %tmp_24 to i31   ; [#uses=1 type=i31]
  ...
  %tmp6 = add i8 %j_0_reg2mem43_0_i_i_s, 121, !dbg !195 ; [#uses=1 type=i8] [debug line = 26:13]
  ...
  %tmp_30 = add i17 %tmp7, %tmp1_cast, !dbg !195  ; [#uses=1 type=i17] [debug line = 26:13]
  %gep_idx52_i_i_cast = zext i17 %tmp_30 to i31   ; [#uses=1 type=i31]
  ...
  %tmp5 = add i5 %j_0_reg2mem43_0_i_i_1, -14, !dbg !195 ; [#uses=1 type=i5] [debug line = 26:13]
  ...
  %p_reg2mem9_0_i_i = fadd float %product_1_reg2mem45_s, %tmp_35, !dbg !195 ; [#uses=1 type=float] [debug line = 26:13]
  br label %.preheader, !dbg !214                 ; [debug line = 24:32]
...
._crit_edge.i.i:                                  ; preds = %.loopexit
  ...
  %p_reg2mem_0_i_i = fadd float %product_0_reg2mem49_s, %tmp_7, !dbg !215 ; [#uses=2 type=float] [debug line = 31:5]
  ...
  %tmp_11 = fcmp olt float %p_reg2mem_0_i_i, 0.000000e+00, !dbg !216 ; [#uses=1 type=i1] [debug line = 32:5]
  %tmp_12 = and i1 %tmp_10, %tmp_11, !dbg !216    ; [#uses=1 type=i1] [debug line = 32:5]
  ...
  %indvar_inc_reg2mem = add i6 1, %indvar_reg2mem69_0_i_1 ; [#uses=1 type=i6]
  br label %for.header.i.i
...
entry:
  ...
  %empty_10 = zext i2 %1 to i8                    ; [#uses=1 type=i8]
  %empty_11 = shl i8 %empty, 2                    ; [#uses=1 type=i8]
  %empty_12 = or i8 %empty_11, %empty_10          ; [#uses=1 type=i8]
  ret i8 %empty_12
}
...
entry:
  ...
  %empty_13 = zext i2 %1 to i6                    ; [#uses=1 type=i6]
  %empty_14 = shl i6 %empty, 2                    ; [#uses=1 type=i6]
...
!60 = metadata !{i32 786473, metadata !"executeFirstLayer1_p2_compute_unit", metadata !"C:\5CUsers\5CRA_prof_Jeon\5Csiddharth\5Clayer1_con_p2\5Csolution1\5C.autopilot\5Cdb", null} ; [ DW_TAG_file_type ]
...
!85 = metadata !{i32 786454, null, metadata !"executeFirstLayer1_p2_args_t", metadata !60, i32 23, i64 0, i64 0, i64 0, i32 0, metadata !86} ; [ DW_TAG_typedef ]
...
!149 = metadata !{i32 786473, metadata !"C:/Xilinx/Vivado_HLS/2016.4/common/technology/autopilot/opencl\5Caesl_gen_cu_body.inc", metadata !"C:\5CUsers\5CRA_prof_Jeon\5Csiddharth\5Clayer1_con_p2\5Csolution1\5C.autopilot\5Cdb", null} ; [ DW_TAG_file_type ]
...
!157 = metadata !{i32 786473, metadata !"C:/Xilinx/Vivado_HLS/2016.4/common/technology/autopilot/opencl/libspir_types.h", metadata !"C:\5CUsers\5CRA_prof_Jeon\5Csiddharth\5Clayer1_con_p2\5Csolution1\5C.autopilot\5Cdb", null} ; [ DW_TAG_file_type ]
...
!201 = metadata !{i32 786478, i32 0, metadata !202, metadata !"executeFirstLayer1_p2", metadata !"executeFirstLayer1_p2", metadata !"", metadata !202, i32 2, metadata !203, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, null, metadata !79, i32 4} ; [ DW_TAG_subprogram ]
!202 = metadata !{i32 786473, metadata !"layer1_con_p2/executeFirstLayer1_conv_p2.cl", metadata !"C:\5CUsers\5CRA_prof_Jeon\5Csiddharth", null} ; [ DW_TAG_file_type ]
...
!208 = metadata !{i32 17, i32 5, metadata !200, null}
!209 = metadata !{i32 15, i32 15, metadata !200, null}
!210 = metadata !{i32 20, i32 5, metadata !200, null}
!211 = metadata !{i32 22, i32 18, metadata !199, null}
!212 = metadata !{i32 22, i32 28, metadata !199, null}
!213 = metadata !{i32 24, i32 22, metadata !197, null}
!214 = metadata !{i32 24, i32 32, metadata !197, null}
!215 = metadata !{i32 31, i32 5, metadata !200, null}
!216 = metadata !{i32 32, i32 5, metadata !200, null}
