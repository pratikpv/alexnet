...
; [#uses=0]
define spir_func void @executeFirstLayer1_p2(i32 addrspace(1)* %gmem, %struct.three_tuple_t* %group_id, %struct.executeFirstLayer1_p2_args_t* %args) {
  ...
  call spir_func void (...)* @_ssdm_op_SpecInterface(%struct.executeFirstLayer1_p2_args_t* %args, i8* getelementptr inbounds ([10 x i8]* @.str2, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([8 x i8]* @.str3, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !121 ; [debug line = 70:1]
