...
#line 1 "executeFirstLayer1_p4_compute_unit"
...
/* KernelID: A, Kernel Name: executeFirstLayer1_p4 */
...
public:
  ...
  inline __attribute__((always_inline)) static void
  aesl_keep_name_0_args(executeFirstLayer1_p4_args_t* args) {
...
void
__AESL_call_work_item_NA(volatile __attribute__((address_space(16776960))) unsigned int* gmem, __spir_rt_info_t *rt_info, executeFirstLayer1_p4_args_t *args)
{
...
void
__AESL_work_groupA(__attribute__((address_space(16776960))) volatile unsigned int* gmem, three_tuple_t *group_id, executeFirstLayer1_p4_args_t *args)
{
