; ModuleID = 'C:/Users/RA_prof_Jeon/siddharth/HLS/executeFirstLayer1_p4/solution1/.autopilot/db/a.g.bc'
target datalayout = "e-p:32:32:32-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v16:16:16-v24:32:32-v32:32:32-v48:64:64-v64:64:64-v96:128:128-v128:128:128-v192:256:256-v256:256:256-v512:512:512-v1024:1024:1024"
target triple = "spir-unknown-linux-gnu"

; [#uses=0]
define spir_kernel void @executeFirstLayer1_p4(float addrspace(1)* %bias, float addrspace(1)* %Layer1_Neurons_GPU, float addrspace(1)* %Layer1_Weights_GPU, float addrspace(1)* %Layer2_Neurons_GPU) nounwind {
  ...
  store i32 32, i32* %r_offset, align 4, !dbg !32 ; [debug line = 6:19]
...
!5 = metadata !{i32 786478, i32 0, metadata !6, metadata !"executeFirstLayer1_p4", metadata !"executeFirstLayer1_p4", metadata !"", metadata !6, i32 2, metadata !7, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, void (float addrspace(1)*, float addrspace(1)*, float addrspace(1)*, float addrspace(1)*)* @executeFirstLayer1_p4, null, null, metadata !11, i32 4} ; [ DW_TAG_subprogram ]
...
!13 = metadata !{void (float addrspace(1)*, float addrspace(1)*, float addrspace(1)*, float addrspace(1)*)* @executeFirstLayer1_p4, metadata !14, metadata !15, metadata !16, metadata !17, metadata !18, metadata !19}
...
!19 = metadata !{metadata !"reqd_work_group_size", i32 23, i32 23, i32 1}
...
!32 = metadata !{i32 6, i32 19, metadata !29, null}
