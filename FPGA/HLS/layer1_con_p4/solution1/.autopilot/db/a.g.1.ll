; ModuleID = 'C:/Users/RA_prof_Jeon/siddharth/HLS/executeFirstLayer1_p4/solution1/.autopilot/db/a.g.1.bc'
...
%struct.executeFirstLayer1_p4_args_t.7.11 = type { i32, i32, i32, i32 }
...
; [#uses=0]
define void @executeFirstLayer1_p4(i32 addrspace(1)* %gmem, %struct.three_tuple_t.6.10* %group_id, %struct.executeFirstLayer1_p4_args_t.7.11* %args) {
  ...
  call void @llvm.dbg.value(metadata !{%struct.executeFirstLayer1_p4_args_t.7.11* %args}, i64 0, metadata !100), !dbg !101 ; [debug line = 59:145] [debug variable = args]
  ...
  call void @llvm.dbg.value(metadata !{%struct.executeFirstLayer1_p4_args_t.7.11* %args}, i64 0, metadata !110), !dbg !111 ; [debug line = 34:55@66:1] [debug variable = args]
  %args.addr = getelementptr inbounds %struct.executeFirstLayer1_p4_args_t.7.11* %args, i32 0, i32 0, !dbg !113 ; [#uses=2 type=i32*] [debug line = 35:5@66:1]
  ...
  %args.addr.1 = getelementptr inbounds %struct.executeFirstLayer1_p4_args_t.7.11* %args, i32 0, i32 1, !dbg !115 ; [#uses=2 type=i32*] [debug line = 36:5@66:1]
  ...
  %args.addr.2 = getelementptr inbounds %struct.executeFirstLayer1_p4_args_t.7.11* %args, i32 0, i32 2, !dbg !116 ; [#uses=2 type=i32*] [debug line = 37:5@66:1]
  ...
  %args.addr.3 = getelementptr inbounds %struct.executeFirstLayer1_p4_args_t.7.11* %args, i32 0, i32 3, !dbg !117 ; [#uses=2 type=i32*] [debug line = 38:5@66:1]
  ...
  call void (...)* @_ssdm_op_SpecInterface(%struct.executeFirstLayer1_p4_args_t.7.11* %args, i8* getelementptr inbounds ([10 x i8]* @.str2, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([8 x i8]* @.str3, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !121 ; [debug line = 70:1]
  ...
  call void @llvm.dbg.value(metadata !{%struct.executeFirstLayer1_p4_args_t.7.11* %args}, i64 0, metadata !147), !dbg !148 ; [debug line = 48:153] [debug variable = args]
...
for.header55.i.i:                                 ; preds = %for.body56.i.i, %0
  ...
  %tmp.9 = icmp eq i32 %indvar57.reg2mem69.0.i.i, 23 ; [#uses=1 type=i1]
...
for.header.i.i.preheader:                         ; preds = %for.header55.i.i
  %row.0.reg2mem.0.i.i = add i32 %indvar57.reg2mem69.0.i.i, 32, !dbg !161 ; [#uses=2 type=i32] [debug line = 14:15]
  %.reg2mem31.0.i.i = mul i32 %row.0.reg2mem.0.i.i, 2724, !dbg !162 ; [#uses=3 type=i32] [debug line = 17:5]
  ...
  %tmp.12 = mul nsw i32 %row.0.reg2mem.0.i.i, 55, !dbg !160 ; [#uses=1 type=i32] [debug line = 34:5]
...
for.header.i.i:                                   ; preds = %._crit_edge.i.i, %for.header.i.i.preheader
  ...
  %tmp.13 = icmp eq i32 %indvar.reg2mem67.0.i.i, 23 ; [#uses=1 type=i1]
...
.split.i.i:                                       ; preds = %for.header.i.i
  ...
  %col.0.reg2mem.0.i.i = add i32 %indvar.reg2mem67.0.i.i, 32, !dbg !163 ; [#uses=2 type=i32] [debug line = 15:15]
  %.reg2mem27.0.i.i = mul i32 %col.0.reg2mem.0.i.i, 12, !dbg !164 ; [#uses=3 type=i32] [debug line = 20:5]
  br label %3, !dbg !165                          ; [debug line = 22:18]
...
; <label>:3                                       ; preds = %5, %.split.i.i
  ...
  %exitcond5 = icmp eq i32 %i.0.reg2mem45.0.i.i, 11, !dbg !165 ; [#uses=1 type=i1] [debug line = 22:18]
  br i1 %exitcond5, label %._crit_edge.i.i, label %.preheader.preheader, !dbg !165 ; [debug line = 22:18]

.preheader.preheader:                             ; preds = %3
  %tmp.19 = mul i32 %i.0.reg2mem45.0.i.i, 681, !dbg !154 ; [#uses=3 type=i32] [debug line = 26:13]
  %tmp.20 = mul nsw i32 %i.0.reg2mem45.0.i.i, 11, !dbg !154 ; [#uses=3 type=i32] [debug line = 26:13]
  br label %.preheader, !dbg !166                 ; [debug line = 24:22]
...
.preheader:                                       ; preds = %4, %.preheader.preheader
  ...
  %exitcond = icmp eq i32 %j.0.reg2mem41.0.i.i, 11, !dbg !166 ; [#uses=1 type=i1] [debug line = 24:22]
  br i1 %exitcond, label %5, label %4, !dbg !166  ; [debug line = 24:22]

; <label>:4                                       ; preds = %.preheader
  %tmp.21 = mul nsw i32 %j.0.reg2mem41.0.i.i, 3, !dbg !154 ; [#uses=3 type=i32] [debug line = 26:13]
  ...
  %tmp.27 = add i32 %tmp.26, %j.0.reg2mem41.0.i.i, !dbg !154 ; [#uses=1 type=i32] [debug line = 26:13]
  ...
  %tmp.36 = add i32 %tmp.35, %j.0.reg2mem41.0.i.i, !dbg !154 ; [#uses=1 type=i32] [debug line = 26:13]
  ...
  %tmp.46 = add i32 %tmp.45, %j.0.reg2mem41.0.i.i, !dbg !154 ; [#uses=1 type=i32] [debug line = 26:13]
  ...
  %.reg2mem9.0.i.i = fadd float %product.1.reg2mem43.0.i.i, %tmp.49, !dbg !154 ; [#uses=1 type=float] [debug line = 26:13]
  %.reg2mem7.0.i.i = add nsw i32 %j.0.reg2mem41.0.i.i, 1, !dbg !167 ; [#uses=1 type=i32] [debug line = 24:32]
  br label %.preheader, !dbg !167                 ; [debug line = 24:32]

; <label>:5                                       ; preds = %.preheader
  %product.1.reg2mem43.0.i.i.lcssa = phi float [ %product.1.reg2mem43.0.i.i, %.preheader ] ; [#uses=1 type=float]
  %.reg2mem5.0.i.i = add nsw i32 %i.0.reg2mem45.0.i.i, 1, !dbg !168 ; [#uses=1 type=i32] [debug line = 22:28]
  br label %3, !dbg !168                          ; [debug line = 22:28]
...
._crit_edge.i.i:                                  ; preds = %3
  ...
  %.reg2mem.0.i.i = fadd float %product.0.reg2mem47.0.i.i.lcssa, %tmp.14, !dbg !169 ; [#uses=2 type=float] [debug line = 31:5]
  %tmp.15 = fcmp olt float %.reg2mem.0.i.i, 0.000000e+00, !dbg !170 ; [#uses=1 type=i1] [debug line = 32:5]
...
__AESL_call_work_item_NA4.exit:                   ; preds = %for.header55.i.i
  ret void, !dbg !171                             ; [debug line = 75:1]
}
...
!161 = metadata !{i32 14, i32 15, metadata !159, null}
!162 = metadata !{i32 17, i32 5, metadata !159, null}
!163 = metadata !{i32 15, i32 15, metadata !159, null}
!164 = metadata !{i32 20, i32 5, metadata !159, null}
!165 = metadata !{i32 22, i32 18, metadata !158, null}
!166 = metadata !{i32 24, i32 22, metadata !156, null}
!167 = metadata !{i32 24, i32 32, metadata !156, null}
!168 = metadata !{i32 22, i32 28, metadata !158, null}
!169 = metadata !{i32 31, i32 5, metadata !159, null}
!170 = metadata !{i32 32, i32 5, metadata !159, null}
!171 = metadata !{i32 75, i32 1, metadata !172, null}
!172 = metadata !{i32 786443, metadata !105, metadata !17} ; [ DW_TAG_lexical_block ]
