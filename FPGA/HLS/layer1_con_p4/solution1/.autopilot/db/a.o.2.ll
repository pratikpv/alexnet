; ModuleID = 'C:/Users/RA_prof_Jeon/siddharth/HLS/executeFirstLayer1_p4/solution1/.autopilot/db/a.o.2.bc'
...
@executeFirstLayer1_p4.str = internal unnamed_addr constant [22 x i8] c"executeFirstLayer1_p4\00" ; [#uses=1 type=[22 x i8]*]
...
; [#uses=0]
define void @executeFirstLayer1_p4(i32 addrspace(1)* %gmem, i32* %group_id.x, i32* %group_id.y, i32* %group_id.z, i32* %bias, i32* %Layer1_Neurons_GPU, i32* %Layer1_Weights_GPU, i32* %Layer2_Neurons_GPU) {
  ...
  call void (...)* @_ssdm_op_SpecTopModule([22 x i8]* @executeFirstLayer1_p4.str)
  ...
  %tmp.5.cast = trunc i32 %tmp.5 to i31, !dbg !240 ; [#uses=1 type=i31] [debug line = 26:13]
  %tmp.7 = mul i32 %group_id.x.load, 363, !dbg !240 ; [#uses=3 type=i32] [debug line = 26:13]
  ...
  %tmp.8 = trunc i32 %group_id.x.load to i30, !dbg !252 ; [#uses=1 type=i30] [debug line = 34:5]
  br label %for.header55.i.i

for.header55.i.i:                                 ; preds = %for.body56.i.i, %0
  %indvar57.reg2mem69.0.i.i = phi i5 [ 0, %0 ], [ %indvar.inc58.reg2mem.0.i.i, %for.body56.i.i ] ; [#uses=3 type=i5]
  %indvar57.reg2mem69.0.i.i.cast = zext i5 %indvar57.reg2mem69.0.i.i to i6 ; [#uses=1 type=i6]
  %1 = call i32 (...)* @_ssdm_op_SpecLoopName([13 x i8]* @XCL_WG_DIM_Y.str) nounwind ; [#uses=0 type=i32]
  %tmp.9 = icmp eq i5 %indvar57.reg2mem69.0.i.i, -9 ; [#uses=1 type=i1]
  %2 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 23, i64 23, i64 23) ; [#uses=0 type=i32]
...
for.header.i.i.preheader:                         ; preds = %for.header55.i.i
  %row.0.reg2mem.0.i.i = or i6 %indvar57.reg2mem69.0.i.i.cast, -32, !dbg !253 ; [#uses=2 type=i6] [debug line = 14:15]
  %row.0.reg2mem.0.i.i.cast21.cast = zext i6 %row.0.reg2mem.0.i.i to i13, !dbg !253 ; [#uses=1 type=i13] [debug line = 14:15]
  %row.0.reg2mem.0.i.i.cast.cast = zext i6 %row.0.reg2mem.0.i.i to i18, !dbg !254 ; [#uses=1 type=i18] [debug line = 17:5]
  %.reg2mem31.0.i.i = mul i18 %row.0.reg2mem.0.i.i.cast.cast, 2724, !dbg !254 ; [#uses=3 type=i18] [debug line = 17:5]
  %tmp. = or i18 %.reg2mem31.0.i.i, 1, !dbg !240  ; [#uses=1 type=i18] [debug line = 26:13]
  %tmp..cast = zext i18 %tmp. to i19, !dbg !240   ; [#uses=1 type=i19] [debug line = 26:13]
  %tmp.1 = or i18 %.reg2mem31.0.i.i, 2, !dbg !240 ; [#uses=1 type=i18] [debug line = 26:13]
  %tmp.1.cast = zext i18 %tmp.1 to i19, !dbg !240 ; [#uses=1 type=i19] [debug line = 26:13]
  %tmp.6 = mul i13 %row.0.reg2mem.0.i.i.cast21.cast, 55, !dbg !252 ; [#uses=1 type=i13] [debug line = 34:5]
  br label %for.header.i.i

for.header.i.i:                                   ; preds = %._crit_edge.i.i, %for.header.i.i.preheader
  %indvar.reg2mem67.0.i.i = phi i5 [ %indvar.inc.reg2mem.0.i.i, %._crit_edge.i.i ], [ 0, %for.header.i.i.preheader ] ; [#uses=3 type=i5]
  %indvar.reg2mem67.0.i.i.cast = zext i5 %indvar.reg2mem67.0.i.i to i6 ; [#uses=1 type=i6]
  %3 = call i32 (...)* @_ssdm_op_SpecLoopName([13 x i8]* @XCL_WG_DIM_X.str) nounwind ; [#uses=0 type=i32]
  %tmp.10 = icmp eq i5 %indvar.reg2mem67.0.i.i, -9 ; [#uses=1 type=i1]
  %4 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 23, i64 23, i64 23) ; [#uses=0 type=i32]
  br i1 %tmp.10, label %for.body56.i.i, label %.split.i.i

for.body56.i.i:                                   ; preds = %for.header.i.i
  %indvar.inc58.reg2mem.0.i.i = add i5 %indvar57.reg2mem69.0.i.i, 1 ; [#uses=1 type=i5]
  br label %for.header55.i.i

.split.i.i:                                       ; preds = %for.header.i.i
  %col.0.reg2mem.0.i.i = or i6 %indvar.reg2mem67.0.i.i.cast, -32, !dbg !255 ; [#uses=3 type=i6] [debug line = 15:15]
  %col.0.reg2mem.0.i.i.cast1 = zext i6 %col.0.reg2mem.0.i.i to i8, !dbg !255 ; [#uses=1 type=i8] [debug line = 15:15]
  %col.0.reg2mem.0.i.i.cast = zext i6 %col.0.reg2mem.0.i.i to i10, !dbg !255 ; [#uses=1 type=i10] [debug line = 15:15]
  %_shl = shl nuw i10 %col.0.reg2mem.0.i.i.cast, 4, !dbg !256 ; [#uses=1 type=i10] [debug line = 20:5]
  %_shl1 = shl nuw i8 %col.0.reg2mem.0.i.i.cast1, 2, !dbg !256 ; [#uses=1 type=i8] [debug line = 20:5]
  %_shl1.cast = zext i8 %_shl1 to i10, !dbg !256  ; [#uses=1 type=i10] [debug line = 20:5]
  %.reg2mem27.0.i.i = sub i10 %_shl, %_shl1.cast, !dbg !256 ; [#uses=2 type=i10] [debug line = 20:5]
  %.reg2mem27.0.i.i.cast1 = zext i10 %.reg2mem27.0.i.i to i19, !dbg !256 ; [#uses=2 type=i19] [debug line = 20:5]
  %.reg2mem27.0.i.i.cast = zext i10 %.reg2mem27.0.i.i to i18, !dbg !256 ; [#uses=1 type=i18] [debug line = 20:5]
  br label %5, !dbg !257                          ; [debug line = 22:18]
...
; <label>:5                                       ; preds = %9, %.split.i.i
  ...
  %i.0.reg2mem45.0.i.i.cast = zext i4 %i.0.reg2mem45.0.i.i to i9, !dbg !257 ; [#uses=1 type=i9] [debug line = 22:18]
  %i.0.reg2mem45.0.i.i.cast1 = zext i4 %i.0.reg2mem45.0.i.i to i14, !dbg !240 ; [#uses=1 type=i14] [debug line = 26:13]
  %exitcond5 = icmp eq i4 %i.0.reg2mem45.0.i.i, -5, !dbg !257 ; [#uses=1 type=i1] [debug line = 22:18]
  %6 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 11, i64 11, i64 11) ; [#uses=0 type=i32]
  br i1 %exitcond5, label %._crit_edge.i.i, label %.preheader.preheader, !dbg !257 ; [debug line = 22:18]

.preheader.preheader:                             ; preds = %5
  %tmp.16 = mul i14 %i.0.reg2mem45.0.i.i.cast1, 681, !dbg !240 ; [#uses=3 type=i14] [debug line = 26:13]
  %tmp.17 = mul i9 %i.0.reg2mem45.0.i.i.cast, 11, !dbg !240 ; [#uses=3 type=i9] [debug line = 26:13]
  %tmp.17.cast = trunc i9 %tmp.17 to i7, !dbg !240 ; [#uses=1 type=i7] [debug line = 26:13]
  br label %.preheader, !dbg !258                 ; [debug line = 24:22]
...
.preheader:                                       ; preds = %8, %.preheader.preheader
  ...
  %j.0.reg2mem41.0.i.i.cast = zext i4 %j.0.reg2mem41.0.i.i to i8, !dbg !258 ; [#uses=1 type=i8] [debug line = 24:22]
  %j.0.reg2mem41.0.i.i.cast14.cast = zext i4 %j.0.reg2mem41.0.i.i to i5, !dbg !258 ; [#uses=1 type=i5] [debug line = 24:22]
  %j.0.reg2mem41.0.i.i.cast1 = zext i4 %j.0.reg2mem41.0.i.i to i7, !dbg !258 ; [#uses=2 type=i7] [debug line = 24:22]
  %j.0.reg2mem41.0.i.i.cast2 = zext i4 %j.0.reg2mem41.0.i.i to i6, !dbg !258 ; [#uses=1 type=i6] [debug line = 24:22]
  %exitcond = icmp eq i4 %j.0.reg2mem41.0.i.i, -5, !dbg !258 ; [#uses=1 type=i1] [debug line = 24:22]
  %7 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 11, i64 11, i64 11) ; [#uses=0 type=i32]
  br i1 %exitcond, label %9, label %8, !dbg !258  ; [debug line = 24:22]

; <label>:8                                       ; preds = %.preheader
  %_shl2 = shl nuw i6 %j.0.reg2mem41.0.i.i.cast2, 2, !dbg !240 ; [#uses=1 type=i6] [debug line = 26:13]
  %_shl2.cast = zext i6 %_shl2 to i7, !dbg !240   ; [#uses=1 type=i7] [debug line = 26:13]
  %tmp.18 = sub i7 %_shl2.cast, %j.0.reg2mem41.0.i.i.cast1, !dbg !240 ; [#uses=1 type=i7] [debug line = 26:13]
  %tmp.18.cast = sext i7 %tmp.18 to i14, !dbg !240 ; [#uses=3 type=i14] [debug line = 26:13]
  %tmp = add i18 %.reg2mem27.0.i.i.cast, %.reg2mem31.0.i.i, !dbg !240 ; [#uses=1 type=i18] [debug line = 26:13]
  %tmp1 = add i14 %tmp.18.cast, %tmp.16, !dbg !240 ; [#uses=1 type=i14] [debug line = 26:13]
  %tmp1.cast = sext i14 %tmp1 to i18, !dbg !240   ; [#uses=1 type=i18] [debug line = 26:13]
  %tmp.21 = add i18 %tmp, %tmp1.cast, !dbg !240   ; [#uses=1 type=i18] [debug line = 26:13]
  ...
  %tmp2 = add i7 %j.0.reg2mem41.0.i.i.cast1, %tmp.17.cast, !dbg !240 ; [#uses=1 type=i7] [debug line = 26:13]
  %tmp.31 = zext i7 %tmp2 to i30, !dbg !240       ; [#uses=1 type=i30] [debug line = 26:13]
  %tmp.32 = trunc i32 %tmp.7 to i30, !dbg !240    ; [#uses=1 type=i30] [debug line = 26:13]
  %tmp.24.cast = add i30 %tmp.32, %tmp.31, !dbg !240 ; [#uses=1 type=i30] [debug line = 26:13]
  ...
  %tmp.26 = fmul float %tmp.22, %tmp.25, !dbg !240 ; [#uses=1 type=float] [debug line = 26:13]
  %tmp3 = add i19 %.reg2mem27.0.i.i.cast1, %tmp..cast, !dbg !240 ; [#uses=1 type=i19] [debug line = 26:13]
  %tmp4 = add i14 %tmp.18.cast, %tmp.16, !dbg !240 ; [#uses=1 type=i14] [debug line = 26:13]
  %tmp4.cast = sext i14 %tmp4 to i19, !dbg !240   ; [#uses=1 type=i19] [debug line = 26:13]
  %tmp.29 = add i19 %tmp3, %tmp4.cast, !dbg !240  ; [#uses=1 type=i19] [debug line = 26:13]
  %gep_idx36.i.i.cast = zext i19 %tmp.29 to i31   ; [#uses=1 type=i31]
  ...
  %tmp.33 = trunc i32 %tmp.7 to i30, !dbg !240    ; [#uses=1 type=i30] [debug line = 26:13]
  %tmp.37 = zext i9 %tmp.17 to i30, !dbg !240     ; [#uses=1 type=i30] [debug line = 26:13]
  %tmp6 = add i8 %j.0.reg2mem41.0.i.i.cast, 121, !dbg !240 ; [#uses=1 type=i8] [debug line = 26:13]
  %tmp.38 = zext i8 %tmp6 to i30, !dbg !240       ; [#uses=1 type=i30] [debug line = 26:13]
  %tmp.41 = add i30 %tmp.37, %tmp.33, !dbg !240   ; [#uses=1 type=i30] [debug line = 26:13]
  %tmp.33.cast = add i30 %tmp.41, %tmp.38, !dbg !240 ; [#uses=1 type=i30] [debug line = 26:13]
  ...
  %tmp.35 = fmul float %tmp.30, %tmp.34, !dbg !240 ; [#uses=1 type=float] [debug line = 26:13]
  %tmp.36 = fadd float %tmp.26, %tmp.35, !dbg !240 ; [#uses=1 type=float] [debug line = 26:13]
  %tmp7 = add i19 %.reg2mem27.0.i.i.cast1, %tmp.1.cast, !dbg !240 ; [#uses=1 type=i19] [debug line = 26:13]
  %tmp8 = add i14 %tmp.18.cast, %tmp.16, !dbg !240 ; [#uses=1 type=i14] [debug line = 26:13]
  %tmp8.cast = sext i14 %tmp8 to i19, !dbg !240   ; [#uses=1 type=i19] [debug line = 26:13]
  %tmp.39 = add i19 %tmp7, %tmp8.cast, !dbg !240  ; [#uses=1 type=i19] [debug line = 26:13]
  %gep_idx52.i.i.cast = zext i19 %tmp.39 to i31   ; [#uses=1 type=i31]
  ...
  %tmp.42 = trunc i32 %tmp.7 to i30, !dbg !240    ; [#uses=1 type=i30] [debug line = 26:13]
  %tmp.43 = zext i9 %tmp.17 to i30, !dbg !240     ; [#uses=1 type=i30] [debug line = 26:13]
  %tmp10 = add i5 %j.0.reg2mem41.0.i.i.cast14.cast, -14, !dbg !240 ; [#uses=1 type=i5] [debug line = 26:13]
  %tmp10.cast = sext i5 %tmp10 to i8, !dbg !240   ; [#uses=1 type=i8] [debug line = 26:13]
  %tmp.47 = zext i8 %tmp10.cast to i30, !dbg !240 ; [#uses=1 type=i30] [debug line = 26:13]
  %tmp.48 = add i30 %tmp.43, %tmp.42, !dbg !240   ; [#uses=1 type=i30] [debug line = 26:13]
  %tmp.43.cast = add i30 %tmp.48, %tmp.47, !dbg !240 ; [#uses=1 type=i30] [debug line = 26:13]
  ...
  %tmp.45 = fmul float %tmp.40, %tmp.44, !dbg !240 ; [#uses=1 type=float] [debug line = 26:13]
  %tmp.46 = fadd float %tmp.36, %tmp.45, !dbg !240 ; [#uses=1 type=float] [debug line = 26:13]
  %.reg2mem9.0.i.i = fadd float %product.1.reg2mem43.0.i.i, %tmp.46, !dbg !240 ; [#uses=1 type=float] [debug line = 26:13]
  %.reg2mem7.0.i.i = add i4 %j.0.reg2mem41.0.i.i, 1, !dbg !259 ; [#uses=1 type=i4] [debug line = 24:32]
  br label %.preheader, !dbg !259                 ; [debug line = 24:32]

; <label>:9                                       ; preds = %.preheader
  %product.1.reg2mem43.0.i.i.lcssa = phi float [ %product.1.reg2mem43.0.i.i, %.preheader ] ; [#uses=1 type=float]
  %.reg2mem5.0.i.i = add i4 %i.0.reg2mem45.0.i.i, 1, !dbg !260 ; [#uses=1 type=i4] [debug line = 22:28]
  br label %5, !dbg !260                          ; [debug line = 22:28]
...
._crit_edge.i.i:                                  ; preds = %5
  ...
  %.reg2mem.0.i.i = fadd float %product.0.reg2mem47.0.i.i.lcssa, %tmp.11, !dbg !261 ; [#uses=3 type=float] [debug line = 31:5]
  ...
  %tmp.19 = fcmp olt float %.reg2mem.0.i.i, 0.000000e+00, !dbg !262 ; [#uses=1 type=i1] [debug line = 32:5]
  %tmp.20 = and i1 %tmp.14, %tmp.19, !dbg !262    ; [#uses=1 type=i1] [debug line = 32:5]
  %tmp.23 = mul i30 %tmp.8, 3025, !dbg !252       ; [#uses=1 type=i30] [debug line = 34:5]
  %tmp.24 = zext i6 %col.0.reg2mem.0.i.i to i30, !dbg !252 ; [#uses=1 type=i30] [debug line = 34:5]
  %tmp.27 = add i30 %tmp.24, %tmp.23, !dbg !252   ; [#uses=1 type=i30] [debug line = 34:5]
  %tmp.28 = zext i13 %tmp.6 to i30, !dbg !252     ; [#uses=1 type=i30] [debug line = 34:5]
  %tmp.14.cast = add i30 %tmp.28, %tmp.27, !dbg !252 ; [#uses=1 type=i30] [debug line = 34:5]
  ...
  %indvar.inc.reg2mem.0.i.i = add i5 %indvar.reg2mem67.0.i.i, 1 ; [#uses=1 type=i5]
...
__AESL_call_work_item_NA4.exit:                   ; preds = %for.header55.i.i
  ret void, !dbg !263                             ; [debug line = 75:1]
}
...
!9 = metadata !{i32 786449, i32 0, i32 4, metadata !"aesl_gen-tmpA.cpp", metadata !"C:\5CUsers\5CRA_prof_Jeon\5Csiddharth\5CHLS\5CexecuteFirstLayer1_p4\5Csolution1\5C.autopilot\5Cdb", metadata !"clang version 3.1 ", i1 true, i1 false, metadata !"", i32 0, metadata !10, metadata !10, metadata !11, metadata !81} ; [ DW_TAG_compile_unit ]
!10 = metadata !{i32 0}
...
!13 = metadata !{i32 786473, metadata !"executeFirstLayer1_p4_compute_unit", metadata !"C:\5CUsers\5CRA_prof_Jeon\5Csiddharth\5CHLS\5CexecuteFirstLayer1_p4\5Csolution1\5C.autopilot\5Cdb", null} ; [ DW_TAG_file_type ]
...
!22 = metadata !{i32 786473, metadata !"C:/Xilinx/Vivado_HLS/2016.4/common/technology/autopilot/opencl/libspir_types.h", metadata !"C:\5CUsers\5CRA_prof_Jeon\5Csiddharth\5CHLS\5CexecuteFirstLayer1_p4\5Csolution1\5C.autopilot\5Cdb", null} ; [ DW_TAG_file_type ]
...
!51 = metadata !{i32 786454, null, metadata !"executeFirstLayer1_p4_args_t", metadata !13, i32 23, i64 0, i64 0, i64 0, i32 0, metadata !52} ; [ DW_TAG_typedef ]
...
!73 = metadata !{i32 786478, i32 0, metadata !60, metadata !"aesl_keep_name_0_args", metadata !"aesl_keep_name_0_args", metadata !"_ZN20aesl_keep_name_class21aesl_keep_name_0_argsEP28executeFirstLayer1_p4_args_t", metadata !13, i32 34, metadata !74, i1 false, i1 false, i32 0, i32 0, null, i32 256, i1 false, null, null, i32 0, metadata !48, i32 34} ; [ DW_TAG_subprogram ]
...
!79 = metadata !{i32 786478, i32 0, null, metadata !"aesl_keep_name_0_args", metadata !"aesl_keep_name_0_args", metadata !"_ZN20aesl_keep_name_class21aesl_keep_name_0_argsEP28executeFirstLayer1_p4_args_t", metadata !13, i32 34, metadata !74, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !73, metadata !48, i32 34} ; [ DW_TAG_subprogram ]
...
!84 = metadata !{i32 786473, metadata !"C:/Xilinx/Vivado_HLS/2016.4/common/technology/autopilot/opencl\5Caesl_gen_cu_body.inc", metadata !"C:\5CUsers\5CRA_prof_Jeon\5Csiddharth\5CHLS\5CexecuteFirstLayer1_p4\5Csolution1\5C.autopilot\5Cdb", null} ; [ DW_TAG_file_type ]
...
!87 = metadata !{i32 790546, i32 0, null, metadata !"rt_info.local_size", metadata !"rt_info.local_size", metadata !"rt_info.local_size", metadata !84, i32 49, metadata !88, i32 1, i32 1, null} ; [ DW_TAG_variable_field ]
...
!89 = metadata !{metadata !30}
!90 = metadata !{i32 790546, i32 0, null, metadata !"rt_info.group_id", metadata !"rt_info.group_id", metadata !"rt_info.group_id", metadata !84, i32 49, metadata !91, i32 1, i32 1, null} ; [ DW_TAG_variable_field ]
...
!92 = metadata !{metadata !33}
!93 = metadata !{i32 790546, i32 0, null, metadata !"rt_info.global_id", metadata !"rt_info.global_id", metadata !"rt_info.global_id", metadata !84, i32 49, metadata !94, i32 1, i32 1, null} ; [ DW_TAG_variable_field ]
...
!95 = metadata !{metadata !29}
!96 = metadata !{i32 790546, i32 0, null, metadata !"rt_info.global_offset", metadata !"rt_info.global_offset", metadata !"rt_info.global_offset", metadata !84, i32 49, metadata !97, i32 1, i32 1, null} ; [ DW_TAG_variable_field ]
...
!98 = metadata !{metadata !34}
!99 = metadata !{i32 790546, i32 0, null, metadata !"rt_info.scheduler_context", metadata !"rt_info.scheduler_context", metadata !"rt_info.scheduler_context", metadata !84, i32 49, metadata !100, i32 1, i32 1, null} ; [ DW_TAG_variable_field ]
!100 = metadata !{i32 786438, null, metadata !"__spir_rt_info_tT", metadata !22, i32 120, i64 32, i64 64, i32 0, i32 0, null, metadata !101, i32 0, null, null} ; [ DW_TAG_class_field_type ]
!101 = metadata !{metadata !40}
!102 = metadata !{i32 790546, i32 0, null, metadata !"rt_info.pthread_barrier", metadata !"rt_info.pthread_barrier", metadata !"rt_info.pthread_barrier", metadata !84, i32 49, metadata !103, i32 1, i32 1, null} ; [ DW_TAG_variable_field ]
!103 = metadata !{i32 786438, null, metadata !"__spir_rt_info_tT", metadata !22, i32 120, i64 32, i64 64, i32 0, i32 0, null, metadata !104, i32 0, null, null} ; [ DW_TAG_class_field_type ]
!104 = metadata !{metadata !35}
!105 = metadata !{i32 790546, i32 0, null, metadata !"rt_info.local_id", metadata !"rt_info.local_id", metadata !"rt_info.local_id", metadata !84, i32 49, metadata !106, i32 1, i32 1, null} ; [ DW_TAG_variable_field ]
...
!107 = metadata !{metadata !31}
!108 = metadata !{i32 790546, i32 0, null, metadata !"rt_info.pe_context", metadata !"rt_info.pe_context", metadata !"rt_info.pe_context", metadata !84, i32 49, metadata !109, i32 1, i32 1, null} ; [ DW_TAG_variable_field ]
...
!112 = metadata !{i32 786438, null, metadata !"__spir_rt_info_tT", metadata !22, i32 120, i64 8, i64 64, i32 0, i32 0, null, metadata !113, i32 0, null, null} ; [ DW_TAG_class_field_type ]
!113 = metadata !{metadata !37}
!114 = metadata !{i32 790546, i32 0, null, metadata !"rt_info.printf_buffer", metadata !"rt_info.printf_buffer", metadata !"rt_info.printf_buffer", metadata !84, i32 49, metadata !115, i32 1, i32 1, null} ; [ DW_TAG_variable_field ]
!115 = metadata !{i32 786438, null, metadata !"__spir_rt_info_tT", metadata !22, i32 120, i64 64, i64 64, i32 0, i32 0, null, metadata !116, i32 0, null, null} ; [ DW_TAG_class_field_type ]
!116 = metadata !{metadata !42}
!117 = metadata !{i32 790546, i32 0, null, metadata !"rt_info.global_size", metadata !"rt_info.global_size", metadata !"rt_info.global_size", metadata !84, i32 49, metadata !118, i32 1, i32 1, null} ; [ DW_TAG_variable_field ]
!118 = metadata !{i32 786438, null, metadata !"__spir_rt_info_tT", metadata !22, i32 120, i64 96, i64 64, i32 0, i32 0, null, metadata !119, i32 0, null, null} ; [ DW_TAG_class_field_type ]
!119 = metadata !{metadata !25}
!120 = metadata !{i32 790546, i32 0, null, metadata !"rt_info.num_groups", metadata !"rt_info.num_groups", metadata !"rt_info.num_groups", metadata !84, i32 49, metadata !121, i32 1, i32 1, null} ; [ DW_TAG_variable_field ]
!121 = metadata !{i32 786438, null, metadata !"__spir_rt_info_tT", metadata !22, i32 120, i64 96, i64 64, i32 0, i32 0, null, metadata !122, i32 0, null, null} ; [ DW_TAG_class_field_type ]
!122 = metadata !{metadata !32}
...
!240 = metadata !{i32 26, i32 13, metadata !241, null}
!241 = metadata !{i32 786443, metadata !242, i32 25, i32 9, metadata !247, i32 4} ; [ DW_TAG_lexical_block ]
!242 = metadata !{i32 786443, metadata !243, i32 24, i32 9, metadata !247, i32 3} ; [ DW_TAG_lexical_block ]
!243 = metadata !{i32 786443, metadata !244, i32 23, i32 5, metadata !247, i32 2} ; [ DW_TAG_lexical_block ]
!244 = metadata !{i32 786443, metadata !245, i32 22, i32 5, metadata !247, i32 1} ; [ DW_TAG_lexical_block ]
!245 = metadata !{i32 786443, metadata !246, i32 4, i32 1, metadata !247, i32 0} ; [ DW_TAG_lexical_block ]
!246 = metadata !{i32 786478, i32 0, metadata !247, metadata !"executeFirstLayer1_p4", metadata !"executeFirstLayer1_p4", metadata !"", metadata !247, i32 2, metadata !248, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, null, metadata !48, i32 4} ; [ DW_TAG_subprogram ]
!247 = metadata !{i32 786473, metadata !"executeFirstLayer1_p4/executeFirstLayer1_p4.cl", metadata !"C:\5CUsers\5CRA_prof_Jeon\5Csiddharth\5CHLS", null} ; [ DW_TAG_file_type ]
...
!252 = metadata !{i32 34, i32 5, metadata !245, null}
!253 = metadata !{i32 14, i32 15, metadata !245, null}
!254 = metadata !{i32 17, i32 5, metadata !245, null}
!255 = metadata !{i32 15, i32 15, metadata !245, null}
!256 = metadata !{i32 20, i32 5, metadata !245, null}
!257 = metadata !{i32 22, i32 18, metadata !244, null}
!258 = metadata !{i32 24, i32 22, metadata !242, null}
!259 = metadata !{i32 24, i32 32, metadata !242, null}
!260 = metadata !{i32 22, i32 28, metadata !244, null}
!261 = metadata !{i32 31, i32 5, metadata !245, null}
!262 = metadata !{i32 32, i32 5, metadata !245, null}
!263 = metadata !{i32 75, i32 1, metadata !264, null}
!264 = metadata !{i32 786443, metadata !211, metadata !13} ; [ DW_TAG_lexical_block ]
