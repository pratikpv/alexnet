...
@executeFirstLayer1_p = internal unnamed_addr constant [22 x i8] c"executeFirstLayer1_p4\00"
...
for.header.i.i:                                   ; preds = %0, %._crit_edge.i.i
  ...
  %indvar57_reg2mem69 = phi i5 [ 0, %0 ], [ %indvar57_reg2mem69_0_1, %._crit_edge.i.i ]
  %indvar_reg2mem67_0_i = phi i5 [ 0, %0 ], [ %indvar_inc_reg2mem, %._crit_edge.i.i ]
  %exitcond_flatten = icmp eq i10 %indvar_flatten, -495
...
for.body56.i.i:                                   ; preds = %for.header.i.i
  ...
  %empty_4 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 529, i64 529, i64 529)
  %tmp_9 = icmp eq i5 %indvar_reg2mem67_0_i, -9
  %indvar_reg2mem67_0_i_1 = select i1 %tmp_9, i5 0, i5 %indvar_reg2mem67_0_i
  %indvar_inc58_reg2mem = add i5 %indvar57_reg2mem69, 1
  %row_0_reg2mem_0_i_i_s = call i6 @_ssdm_op_BitConcatenate.i6.i1.i5(i1 true, i5 %indvar_inc58_reg2mem)
  %row_0_reg2mem_0_i_i6 = call i6 @_ssdm_op_BitConcatenate.i6.i1.i5(i1 true, i5 %indvar57_reg2mem69)
  %p_reg2mem31_0_i_i_mid = select i1 %tmp_9, i6 %row_0_reg2mem_0_i_i_s, i6 %row_0_reg2mem_0_i_i6
  ...
  %tmp_cast_mid2 = zext i18 %tmp_cast_mid2_v to i19
  %tmp_1_cast_mid2_v = or i18 %p_reg2mem31_0_i_i_mid_2, 2
  %tmp_1_cast_mid2 = zext i18 %tmp_1_cast_mid2_v to i19
  ...
  %indvar57_reg2mem69_0_1 = select i1 %tmp_9, i5 %indvar_inc58_reg2mem, i5 %indvar57_reg2mem69
  %empty_5 = call i32 (...)* @_ssdm_op_SpecLoopName([13 x i8]* @XCL_WG_DIM_X_str) nounwind
  %col_0_reg2mem_0_i_i = call i6 @_ssdm_op_BitConcatenate.i6.i1.i5(i1 true, i5 %indvar_reg2mem67_0_i_1)
  %p_shl = call i10 @_ssdm_op_BitConcatenate.i10.i1.i5.i4(i1 true, i5 %indvar_reg2mem67_0_i_1, i4 0)
  %p_shl1 = call i8 @_ssdm_op_BitConcatenate.i8.i1.i5.i2(i1 true, i5 %indvar_reg2mem67_0_i_1, i2 0)
  %p_shl1_cast = zext i8 %p_shl1 to i10
  %p_reg2mem27_0_i_i = sub i10 %p_shl, %p_shl1_cast
  %p_reg2mem27_0_i_i_cas = zext i10 %p_reg2mem27_0_i_i to i19
  %p_reg2mem27_0_i_i_cas_1 = zext i10 %p_reg2mem27_0_i_i to i18
  %tmp = add i18 %p_reg2mem31_0_i_i_mid_2, %p_reg2mem27_0_i_i_cas_1
  %tmp3 = add i19 %tmp_cast_mid2, %p_reg2mem27_0_i_i_cas
  %tmp7 = add i19 %tmp_1_cast_mid2, %p_reg2mem27_0_i_i_cas
  br label %.loopexit
...
; <label>:1                                       ; preds = %.preheader
  ...
  %tmp4_cast = sext i14 %tmp1 to i19
  %tmp_24 = add i19 %tmp3, %tmp4_cast
  %gep_idx36_i_i_cast = zext i19 %tmp_24 to i31
  ...
  %tmp_30 = add i19 %tmp7, %tmp4_cast
  %gep_idx52_i_i_cast = zext i19 %tmp_30 to i31
  ...
  %tmp5 = add i5 %j_0_reg2mem41_0_i_i_1, -14
  ...
  %p_reg2mem9_0_i_i = fadd float %product_1_reg2mem43_s, %tmp_35
  br label %.preheader
...
._crit_edge.i.i:                                  ; preds = %.loopexit
  ...
  %p_reg2mem_0_i_i = fadd float %product_0_reg2mem47_s, %tmp_7
  ...
  %indvar_inc_reg2mem = add i5 1, %indvar_reg2mem67_0_i_1
  br label %for.header.i.i
...
entry:
  ...
  %empty_10 = zext i2 %2 to i7
  %empty_11 = shl i7 %empty, 2
  %empty_12 = or i7 %empty_11, %empty_10
  %empty_13 = zext i1 %0 to i8
  %empty_14 = zext i7 %empty_12 to i8
  %empty_15 = shl i8 %empty_13, 7
...
entry:
  ...
  %empty_20 = zext i5 %1 to i6
  %empty_21 = shl i6 %empty, 5
...
entry:
  ...
  %empty_23 = zext i4 %2 to i9
  %empty_24 = shl i9 %empty, 4
  %empty_25 = or i9 %empty_24, %empty_23
  %empty_26 = zext i1 %0 to i10
  %empty_27 = zext i9 %empty_25 to i10
  %empty_28 = shl i10 %empty_26, 9
  %empty_29 = or i10 %empty_28, %empty_27
  ret i10 %empty_29
}
