...
set Library     "hls"
set IPName      "executeFirstLayer"
set Version     "1.0"
set DisplayName "Executefirstlayer"
set Revision    "1905051658"
set Description "An IP generated by Vivado HLS"
set Device      "zynq"
set Taxonomy    "/VIVADO_HLS_IP"

## Variables
set Top "executeFirstLayer"
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 group_id_x W 0x0 "Data signal of group_id_x" {{0 32 group_id_x W 0 "Bit 31 to 0 Data signal of group_id_x"}}} {0x18 group_id_y W 0x0 "Data signal of group_id_y" {{0 32 group_id_y W 0 "Bit 31 to 0 Data signal of group_id_y"}}} {0x20 group_id_z W 0x0 "Data signal of group_id_z" {{0 32 group_id_z W 0 "Bit 31 to 0 Data signal of group_id_z"}}} {0x28 bias W 0x0 "Data signal of bias" {{0 32 bias W 0 "Bit 31 to 0 Data signal of bias"}}} {0x30 Layer1_Neurons_GPU W 0x0 "Data signal of Layer1_Neurons_GPU" {{0 32 Layer1_Neurons_GPU W 0 "Bit 31 to 0 Data signal of Layer1_Neurons_GPU"}}} {0x38 Layer1_Weights_GPU W 0x0 "Data signal of Layer1_Weights_GPU" {{0 32 Layer1_Weights_GPU W 0 "Bit 31 to 0 Data signal of Layer1_Weights_GPU"}}} {0x40 Layer2_Neurons_GPU W 0x0 "Data signal of Layer2_Neurons_GPU" {{0 32 Layer2_Neurons_GPU W 0 "Bit 31 to 0 Data signal of Layer2_Neurons_GPU"}}} {0x48 r_offset W 0x0 "Data signal of r_offset" {{0 32 r_offset W 0 "Bit 31 to 0 Data signal of r_offset"}}} {0x50 c_offset W 0x0 "Data signal of c_offset" {{0 32 c_offset W 0 "Bit 31 to 0 Data signal of c_offset"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
## System Info
set user_parameters_list {clk_period 10.000000 machine 64 combinational 0 latency 19386370 II x}
...
set enable_xo_gen 0
set kernel_files {C:/Users/RA_prof_Jeon/siddharth/HLS/Alexnet_dev/layer1.cl}
if {$enable_xo_gen} {
