...
#line 1 "executeFirstLayer_compute_unit"
...
/* KernelID: A, Kernel Name: executeFirstLayer */
...
public:
  ...
  inline __attribute__((always_inline)) static void
  aesl_keep_name_0_args(executeFirstLayer_args_t* args) {
    ...
    _ssdm_op_SpecExt("member_name", "r_offset", &args->r_offset);
    _ssdm_op_SpecExt("member_name", "c_offset", &args->c_offset);
  }
};
...
void
__AESL_call_work_item_NA(volatile __attribute__((address_space(16776960))) unsigned int* gmem, __spir_rt_info_t *rt_info, executeFirstLayer_args_t *args)
{
  ...
  unsigned int arg_r_offset = args->r_offset;
  unsigned int arg_c_offset = args->c_offset;
  __SPIR_kernelA(rt_info, arg_bias, arg_Layer1_Neurons_GPU, arg_Layer1_Weights_GPU, arg_Layer2_Neurons_GPU, arg_r_offset, arg_c_offset);
  return;
}

void
__AESL_work_groupA(__attribute__((address_space(16776960))) volatile unsigned int* gmem, three_tuple_t *group_id, executeFirstLayer_args_t *args)
{
#define RT_INFO_REQD_LOCAL_SIZE_X 32
