; ModuleID = 'C:/Users/RA_prof_Jeon/siddharth/HLS/Alexnet_dev/solution1/.autopilot/db/a.g.1.bc'
target datalayout = "e-p:32:32:32-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v16:16:16-v24:32:32-v32:32:32-v48:64:64-v64:64:64-v96:128:128-v128:128:128-v192:256:256-v256:256:256-v512:512:512-v1024:1024:1024"
target triple = "spir-unknown-linux-gnu"

%struct.__spir_rt_info_tT.1.3.7 = type { i32, [3 x i32], [3 x i32], [3 x i32], [3 x i32], [3 x i32], [3 x i32], [3 x i32], i8*, i1, i8*, i8*, i64 }
%struct.__spir_rt_info_tT.2.6 = type { i32, [3 x i32], [3 x i32], [3 x i32], [3 x i32], [3 x i32], [3 x i32], [3 x i32], i8*, i8, i8*, i8*, i64 }
%struct.three_tuple_t.4.8 = type { i32, i32, i32 }
%struct.executeFirstLayer_args_t.5.9 = type { i32, i32, i32, i32, i32, i32 }

@str = internal constant [1 x i8] zeroinitializer ; [#uses=1 type=[1 x i8]*]
@rt_info = internal unnamed_addr global %struct.__spir_rt_info_tT.1.3.7 zeroinitializer, align 8 ; [#uses=27 type=%struct.__spir_rt_info_tT.1.3.7*]
@executeFirstLayer.str = internal unnamed_addr constant [18 x i8] c"executeFirstLayer\00" ; [#uses=1 type=[18 x i8]*]
@__spir_rt_info = global %struct.__spir_rt_info_tT.2.6* null, align 4 ; [#uses=0 type=%struct.__spir_rt_info_tT.2.6**]
...
; [#uses=0]
define void @executeFirstLayer(i32 addrspace(1)* %gmem, %struct.three_tuple_t.4.8* %group_id, %struct.executeFirstLayer_args_t.5.9* %args) {
  call void (...)* @_ssdm_op_SpecTopModule([18 x i8]* @executeFirstLayer.str)
  %.cast.i = alloca %struct.__spir_rt_info_tT.2.6, align 8 ; [#uses=27 type=%struct.__spir_rt_info_tT.2.6*]
  call void @llvm.dbg.value(metadata !{i32 addrspace(1)* %gmem}, i64 0, metadata !101), !dbg !102 ; [debug line = 65:84] [debug variable = gmem]
  call void @llvm.dbg.value(metadata !{%struct.three_tuple_t.4.8* %group_id}, i64 0, metadata !103), !dbg !104 ; [debug line = 65:105] [debug variable = group_id]
  call void @llvm.dbg.value(metadata !{%struct.executeFirstLayer_args_t.5.9* %args}, i64 0, metadata !105), !dbg !106 ; [debug line = 65:141] [debug variable = args]
  call void @llvm.dbg.value(metadata !{%struct.three_tuple_t.4.8* %group_id}, i64 0, metadata !107), !dbg !108 ; [debug line = 30:44@71:1] [debug variable = group_id]
  %group_id.addr = getelementptr inbounds %struct.three_tuple_t.4.8* %group_id, i32 0, i32 0, !dbg !111 ; [#uses=2 type=i32*] [debug line = 31:5@71:1]
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str4, i32 0, i32 0), i8* getelementptr inbounds ([11 x i8]* @.str11, i32 0, i32 0), i32* %group_id.addr) nounwind, !dbg !111 ; [debug line = 31:5@71:1]
  %group_id.addr.1 = getelementptr inbounds %struct.three_tuple_t.4.8* %group_id, i32 0, i32 1, !dbg !113 ; [#uses=2 type=i32*] [debug line = 32:5@71:1]
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str4, i32 0, i32 0), i8* getelementptr inbounds ([11 x i8]* @.str12, i32 0, i32 0), i32* %group_id.addr.1) nounwind, !dbg !113 ; [debug line = 32:5@71:1]
  %group_id.addr.2 = getelementptr inbounds %struct.three_tuple_t.4.8* %group_id, i32 0, i32 2, !dbg !114 ; [#uses=2 type=i32*] [debug line = 33:5@71:1]
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str4, i32 0, i32 0), i8* getelementptr inbounds ([11 x i8]* @.str13, i32 0, i32 0), i32* %group_id.addr.2) nounwind, !dbg !114 ; [debug line = 33:5@71:1]
  call void @llvm.dbg.value(metadata !{%struct.executeFirstLayer_args_t.5.9* %args}, i64 0, metadata !115), !dbg !116 ; [debug line = 36:51@72:1] [debug variable = args]
  %args.addr = getelementptr inbounds %struct.executeFirstLayer_args_t.5.9* %args, i32 0, i32 0, !dbg !118 ; [#uses=2 type=i32*] [debug line = 37:5@72:1]
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str4, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8]* @.str5, i32 0, i32 0), i32* %args.addr) nounwind, !dbg !118 ; [debug line = 37:5@72:1]
  %args.addr.1 = getelementptr inbounds %struct.executeFirstLayer_args_t.5.9* %args, i32 0, i32 1, !dbg !120 ; [#uses=2 type=i32*] [debug line = 38:5@72:1]
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str4, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8]* @.str6, i32 0, i32 0), i32* %args.addr.1) nounwind, !dbg !120 ; [debug line = 38:5@72:1]
  %args.addr.2 = getelementptr inbounds %struct.executeFirstLayer_args_t.5.9* %args, i32 0, i32 2, !dbg !121 ; [#uses=2 type=i32*] [debug line = 39:5@72:1]
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str4, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8]* @.str7, i32 0, i32 0), i32* %args.addr.2) nounwind, !dbg !121 ; [debug line = 39:5@72:1]
  %args.addr.3 = getelementptr inbounds %struct.executeFirstLayer_args_t.5.9* %args, i32 0, i32 3, !dbg !122 ; [#uses=2 type=i32*] [debug line = 40:5@72:1]
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str4, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8]* @.str8, i32 0, i32 0), i32* %args.addr.3) nounwind, !dbg !122 ; [debug line = 40:5@72:1]
  %args.addr.4 = getelementptr inbounds %struct.executeFirstLayer_args_t.5.9* %args, i32 0, i32 4, !dbg !123 ; [#uses=2 type=i32*] [debug line = 41:5@72:1]
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str4, i32 0, i32 0), i8* getelementptr inbounds ([9 x i8]* @.str9, i32 0, i32 0), i32* %args.addr.4) nounwind, !dbg !123 ; [debug line = 41:5@72:1]
  %args.addr.5 = getelementptr inbounds %struct.executeFirstLayer_args_t.5.9* %args, i32 0, i32 5, !dbg !124 ; [#uses=2 type=i32*] [debug line = 42:5@72:1]
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str4, i32 0, i32 0), i8* getelementptr inbounds ([9 x i8]* @.str10, i32 0, i32 0), i32* %args.addr.5) nounwind, !dbg !124 ; [debug line = 42:5@72:1]
  ...
  call void (...)* @_ssdm_op_SpecInterface(%struct.three_tuple_t.4.8* %group_id, i8* getelementptr inbounds ([10 x i8]* @.str2, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([8 x i8]* @.str3, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !126 ; [debug line = 74:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 0, i8* getelementptr inbounds ([10 x i8]* @.str2, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([8 x i8]* @.str3, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !127 ; [debug line = 75:1]
  call void (...)* @_ssdm_op_SpecInterface(%struct.executeFirstLayer_args_t.5.9* %args, i8* getelementptr inbounds ([10 x i8]* @.str2, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([8 x i8]* @.str3, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !128 ; [debug line = 76:1]
  store i32 0, i32* getelementptr inbounds (%struct.__spir_rt_info_tT.1.3.7* @rt_info, i32 0, i32 0), align 8, !dbg !129 ; [debug line = 54:3]
  store i32 0, i32* getelementptr inbounds (%struct.__spir_rt_info_tT.1.3.7* @rt_info, i32 0, i32 1, i32 0), align 4, !dbg !131 ; [debug line = 63:3]
  store i32 0, i32* getelementptr inbounds (%struct.__spir_rt_info_tT.1.3.7* @rt_info, i32 0, i32 1, i32 1), align 4, !dbg !132 ; [debug line = 64:3]
  store i32 0, i32* getelementptr inbounds (%struct.__spir_rt_info_tT.1.3.7* @rt_info, i32 0, i32 1, i32 2), align 4, !dbg !133 ; [debug line = 65:3]
  store i32 32, i32* getelementptr inbounds (%struct.__spir_rt_info_tT.1.3.7* @rt_info, i32 0, i32 3, i32 0), align 4, !dbg !134 ; [debug line = 70:3]
  store i32 32, i32* getelementptr inbounds (%struct.__spir_rt_info_tT.1.3.7* @rt_info, i32 0, i32 3, i32 1), align 4, !dbg !135 ; [debug line = 79:3]
  store i32 1, i32* getelementptr inbounds (%struct.__spir_rt_info_tT.1.3.7* @rt_info, i32 0, i32 3, i32 2), align 4, !dbg !136 ; [debug line = 88:3]
  store i32 0, i32* getelementptr inbounds (%struct.__spir_rt_info_tT.1.3.7* @rt_info, i32 0, i32 4, i32 0), align 8, !dbg !137 ; [debug line = 103:3]
  store i32 0, i32* getelementptr inbounds (%struct.__spir_rt_info_tT.1.3.7* @rt_info, i32 0, i32 4, i32 1), align 4, !dbg !138 ; [debug line = 104:3]
  store i32 0, i32* getelementptr inbounds (%struct.__spir_rt_info_tT.1.3.7* @rt_info, i32 0, i32 4, i32 2), align 8, !dbg !139 ; [debug line = 105:3]
  store i32 0, i32* getelementptr inbounds (%struct.__spir_rt_info_tT.1.3.7* @rt_info, i32 0, i32 5, i32 0), align 4, !dbg !140 ; [debug line = 114:3]
  store i32 0, i32* getelementptr inbounds (%struct.__spir_rt_info_tT.1.3.7* @rt_info, i32 0, i32 5, i32 1), align 4, !dbg !141 ; [debug line = 115:3]
  store i32 0, i32* getelementptr inbounds (%struct.__spir_rt_info_tT.1.3.7* @rt_info, i32 0, i32 5, i32 2), align 4, !dbg !142 ; [debug line = 116:3]
  %group_id.load = load i32* %group_id.addr, align 4, !dbg !143 ; [#uses=10 type=i32] [debug line = 121:3]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %group_id.load)
  store i32 %group_id.load, i32* getelementptr inbounds (%struct.__spir_rt_info_tT.1.3.7* @rt_info, i32 0, i32 6, i32 0), align 8, !dbg !143 ; [debug line = 121:3]
  %group_id.load.1 = load i32* %group_id.addr.1, align 4, !dbg !144 ; [#uses=6 type=i32] [debug line = 122:3]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %group_id.load.1)
  store i32 %group_id.load.1, i32* getelementptr inbounds (%struct.__spir_rt_info_tT.1.3.7* @rt_info, i32 0, i32 6, i32 1), align 4, !dbg !144 ; [debug line = 122:3]
  %group_id.load.2 = load i32* %group_id.addr.2, align 4, !dbg !145 ; [#uses=8 type=i32] [debug line = 123:3]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %group_id.load.2)
  store i32 %group_id.load.2, i32* getelementptr inbounds (%struct.__spir_rt_info_tT.1.3.7* @rt_info, i32 0, i32 6, i32 2), align 8, !dbg !145 ; [debug line = 123:3]
  store i32 0, i32* getelementptr inbounds (%struct.__spir_rt_info_tT.1.3.7* @rt_info, i32 0, i32 7, i32 0), align 4, !dbg !146 ; [debug line = 136:3]
  store i32 0, i32* getelementptr inbounds (%struct.__spir_rt_info_tT.1.3.7* @rt_info, i32 0, i32 7, i32 1), align 4, !dbg !147 ; [debug line = 137:3]
  store i32 0, i32* getelementptr inbounds (%struct.__spir_rt_info_tT.1.3.7* @rt_info, i32 0, i32 7, i32 2), align 4, !dbg !148 ; [debug line = 138:3]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %group_id.load)
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 32)
  %tmp = shl i32 %group_id.load, 5, !dbg !149     ; [#uses=3 type=i32] [debug line = 147:3]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 0)
  store i32 %tmp, i32* getelementptr inbounds (%struct.__spir_rt_info_tT.1.3.7* @rt_info, i32 0, i32 2, i32 0), align 8, !dbg !149 ; [debug line = 147:3]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %group_id.load.1)
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 32)
  %tmp.1 = shl i32 %group_id.load.1, 5, !dbg !150 ; [#uses=3 type=i32] [debug line = 148:3]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 0)
  store i32 %tmp.1, i32* getelementptr inbounds (%struct.__spir_rt_info_tT.1.3.7* @rt_info, i32 0, i32 2, i32 1), align 4, !dbg !150 ; [debug line = 148:3]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %group_id.load.2)
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 1)
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 0)
  store i32 %group_id.load.2, i32* getelementptr inbounds (%struct.__spir_rt_info_tT.1.3.7* @rt_info, i32 0, i32 2, i32 2), align 8, !dbg !151 ; [debug line = 149:3]
  call void @llvm.dbg.value(metadata !{i32 addrspace(1)* %gmem}, i64 0, metadata !152), !dbg !153 ; [debug line = 52:90] [debug variable = gmem]
  call void @llvm.dbg.value(metadata !{%struct.executeFirstLayer_args_t.5.9* %args}, i64 0, metadata !154), !dbg !155 ; [debug line = 52:149] [debug variable = args]
  %args.load = load i32* %args.addr, align 4, !dbg !156 ; [#uses=2 type=i32] [debug line = 54:116]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %args.load)
  %tmp.2 = lshr i32 %args.load, 2, !dbg !156      ; [#uses=1 type=i32] [debug line = 54:116]
  %args.load.1 = load i32* %args.addr.1, align 4, !dbg !158 ; [#uses=2 type=i32] [debug line = 55:144]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %args.load.1)
  %tmp.3 = lshr i32 %args.load.1, 2, !dbg !158    ; [#uses=3 type=i32] [debug line = 55:144]
  %args.load.2 = load i32* %args.addr.2, align 4, !dbg !159 ; [#uses=2 type=i32] [debug line = 56:144]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %args.load.2)
  %tmp.4 = lshr i32 %args.load.2, 2, !dbg !159    ; [#uses=3 type=i32] [debug line = 56:144]
  %args.load.3 = load i32* %args.addr.3, align 4, !dbg !160 ; [#uses=2 type=i32] [debug line = 57:144]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %args.load.3)
  %tmp.5 = lshr i32 %args.load.3, 2, !dbg !160    ; [#uses=1 type=i32] [debug line = 57:144]
  %arg_r_offset = load i32* %args.addr.4, align 4, !dbg !161 ; [#uses=2 type=i32] [debug line = 58:45]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %arg_r_offset)
  call void @llvm.dbg.value(metadata !{i32 %arg_r_offset}, i64 0, metadata !162), !dbg !161 ; [debug line = 58:45] [debug variable = arg_r_offset]
  %arg_c_offset = load i32* %args.addr.5, align 4, !dbg !163 ; [#uses=2 type=i32] [debug line = 59:45]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %arg_c_offset)
  call void @llvm.dbg.value(metadata !{i32 %arg_c_offset}, i64 0, metadata !164), !dbg !163 ; [debug line = 59:45] [debug variable = arg_c_offset]
  %.cast.i.addr = getelementptr %struct.__spir_rt_info_tT.2.6* %.cast.i, i32 0, i32 0 ; [#uses=1 type=i32*]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 0)
  store volatile i32 0, i32* %.cast.i.addr, align 8
  %.cast.i.addr.1 = getelementptr %struct.__spir_rt_info_tT.2.6* %.cast.i, i32 0, i32 1, i32 0 ; [#uses=1 type=i32*]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 0)
  store volatile i32 0, i32* %.cast.i.addr.1, align 4
  %.cast.i.addr.2 = getelementptr %struct.__spir_rt_info_tT.2.6* %.cast.i, i32 0, i32 1, i32 1 ; [#uses=1 type=i32*]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 0)
  store volatile i32 0, i32* %.cast.i.addr.2, align 4
  %.cast.i.addr.3 = getelementptr %struct.__spir_rt_info_tT.2.6* %.cast.i, i32 0, i32 1, i32 2 ; [#uses=1 type=i32*]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 0)
  store volatile i32 0, i32* %.cast.i.addr.3, align 4
  %.cast.i.addr.4 = getelementptr %struct.__spir_rt_info_tT.2.6* %.cast.i, i32 0, i32 2, i32 0 ; [#uses=1 type=i32*]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %tmp)
  store volatile i32 %tmp, i32* %.cast.i.addr.4, align 8
  %.cast.i.addr.5 = getelementptr %struct.__spir_rt_info_tT.2.6* %.cast.i, i32 0, i32 2, i32 1 ; [#uses=1 type=i32*]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %tmp.1)
  store volatile i32 %tmp.1, i32* %.cast.i.addr.5, align 4
  %.cast.i.addr.6 = getelementptr %struct.__spir_rt_info_tT.2.6* %.cast.i, i32 0, i32 2, i32 2 ; [#uses=1 type=i32*]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %group_id.load.2)
  store volatile i32 %group_id.load.2, i32* %.cast.i.addr.6, align 8
  %.cast.i.addr.7 = getelementptr %struct.__spir_rt_info_tT.2.6* %.cast.i, i32 0, i32 3, i32 0 ; [#uses=1 type=i32*]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 32)
  store volatile i32 32, i32* %.cast.i.addr.7, align 4
  %.cast.i.addr.8 = getelementptr %struct.__spir_rt_info_tT.2.6* %.cast.i, i32 0, i32 3, i32 1 ; [#uses=1 type=i32*]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 32)
  store volatile i32 32, i32* %.cast.i.addr.8, align 4
  %.cast.i.addr.9 = getelementptr %struct.__spir_rt_info_tT.2.6* %.cast.i, i32 0, i32 3, i32 2 ; [#uses=1 type=i32*]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 1)
  store volatile i32 1, i32* %.cast.i.addr.9, align 4
  %.cast.i.addr.10 = getelementptr %struct.__spir_rt_info_tT.2.6* %.cast.i, i32 0, i32 4, i32 0 ; [#uses=1 type=i32*]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 0)
  store volatile i32 0, i32* %.cast.i.addr.10, align 8
  %.cast.i.addr.11 = getelementptr %struct.__spir_rt_info_tT.2.6* %.cast.i, i32 0, i32 4, i32 1 ; [#uses=1 type=i32*]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 0)
  store volatile i32 0, i32* %.cast.i.addr.11, align 4
  %.cast.i.addr.12 = getelementptr %struct.__spir_rt_info_tT.2.6* %.cast.i, i32 0, i32 4, i32 2 ; [#uses=1 type=i32*]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 0)
  store volatile i32 0, i32* %.cast.i.addr.12, align 8
  %.cast.i.addr.13 = getelementptr %struct.__spir_rt_info_tT.2.6* %.cast.i, i32 0, i32 5, i32 0 ; [#uses=1 type=i32*]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 0)
  store volatile i32 0, i32* %.cast.i.addr.13, align 4
  %.cast.i.addr.14 = getelementptr %struct.__spir_rt_info_tT.2.6* %.cast.i, i32 0, i32 5, i32 1 ; [#uses=1 type=i32*]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 0)
  store volatile i32 0, i32* %.cast.i.addr.14, align 4
  %.cast.i.addr.15 = getelementptr %struct.__spir_rt_info_tT.2.6* %.cast.i, i32 0, i32 5, i32 2 ; [#uses=1 type=i32*]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 0)
  store volatile i32 0, i32* %.cast.i.addr.15, align 4
  %.cast.i.addr.16 = getelementptr %struct.__spir_rt_info_tT.2.6* %.cast.i, i32 0, i32 6, i32 0 ; [#uses=1 type=i32*]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %group_id.load)
  store volatile i32 %group_id.load, i32* %.cast.i.addr.16, align 8
  %.cast.i.addr.17 = getelementptr %struct.__spir_rt_info_tT.2.6* %.cast.i, i32 0, i32 6, i32 1 ; [#uses=1 type=i32*]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %group_id.load.1)
  store volatile i32 %group_id.load.1, i32* %.cast.i.addr.17, align 4
  %.cast.i.addr.18 = getelementptr %struct.__spir_rt_info_tT.2.6* %.cast.i, i32 0, i32 6, i32 2 ; [#uses=1 type=i32*]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %group_id.load.2)
  store volatile i32 %group_id.load.2, i32* %.cast.i.addr.18, align 8
  %.cast.i.addr.19 = getelementptr %struct.__spir_rt_info_tT.2.6* %.cast.i, i32 0, i32 7, i32 0 ; [#uses=1 type=i32*]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 0)
  store volatile i32 0, i32* %.cast.i.addr.19, align 4
  %.cast.i.addr.20 = getelementptr %struct.__spir_rt_info_tT.2.6* %.cast.i, i32 0, i32 7, i32 1 ; [#uses=1 type=i32*]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 0)
  store volatile i32 0, i32* %.cast.i.addr.20, align 4
  %.cast.i.addr.21 = getelementptr %struct.__spir_rt_info_tT.2.6* %.cast.i, i32 0, i32 7, i32 2 ; [#uses=1 type=i32*]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 0)
  store volatile i32 0, i32* %.cast.i.addr.21, align 4
  %.cast.i.addr.22 = getelementptr %struct.__spir_rt_info_tT.2.6* %.cast.i, i32 0, i32 8 ; [#uses=1 type=i8**]
  %rt_info.load = load i8** getelementptr inbounds (%struct.__spir_rt_info_tT.1.3.7* @rt_info, i32 0, i32 8), align 8 ; [#uses=1 type=i8*]
  store volatile i8* %rt_info.load, i8** %.cast.i.addr.22, align 8
  %.cast.i.addr.23 = getelementptr %struct.__spir_rt_info_tT.2.6* %.cast.i, i32 0, i32 9 ; [#uses=1 type=i8*]
  %rt_info.load.1 = load i1* getelementptr inbounds (%struct.__spir_rt_info_tT.1.3.7* @rt_info, i32 0, i32 9), align 4 ; [#uses=2 type=i1]
  ...
  %.cast.i.addr.24 = getelementptr %struct.__spir_rt_info_tT.2.6* %.cast.i, i32 0, i32 10 ; [#uses=1 type=i8**]
  %rt_info.load.2 = load i8** getelementptr inbounds (%struct.__spir_rt_info_tT.1.3.7* @rt_info, i32 0, i32 10), align 8 ; [#uses=1 type=i8*]
  store volatile i8* %rt_info.load.2, i8** %.cast.i.addr.24, align 8
  %.cast.i.addr.25 = getelementptr %struct.__spir_rt_info_tT.2.6* %.cast.i, i32 0, i32 11 ; [#uses=1 type=i8**]
  %rt_info.load.3 = load i8** getelementptr inbounds (%struct.__spir_rt_info_tT.1.3.7* @rt_info, i32 0, i32 11), align 4 ; [#uses=1 type=i8*]
  store volatile i8* %rt_info.load.3, i8** %.cast.i.addr.25, align 4
  %.cast.i.addr.26 = getelementptr %struct.__spir_rt_info_tT.2.6* %.cast.i, i32 0, i32 12 ; [#uses=1 type=i64*]
  %rt_info.load.4 = load i64* getelementptr inbounds (%struct.__spir_rt_info_tT.1.3.7* @rt_info, i32 0, i32 12), align 8 ; [#uses=2 type=i64]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i64 %rt_info.load.4)
  store volatile i64 %rt_info.load.4, i64* %.cast.i.addr.26, align 8
  %tmp.7 = mul i32 %group_id.load, 363, !dbg !165 ; [#uses=3 type=i32] [debug line = 23:13]
  ...
  %tmp.8 = mul i32 %group_id.load, 3025, !dbg !171 ; [#uses=1 type=i32] [debug line = 31:5]
  br label %for.header55.i.i

for.header55.i.i:                                 ; preds = %for.body56.i.i, %0
  %indvar57.reg2mem69.0.i.i = phi i32 [ 0, %0 ], [ %indvar.inc58.reg2mem.0.i.i, %for.body56.i.i ] ; [#uses=4 type=i32]
  %1 = call i32 (...)* @_ssdm_op_SpecLoopName([13 x i8]* @XCL_WG_DIM_Y.str) nounwind ; [#uses=0 type=i32]
  %tmp.9 = icmp eq i32 %indvar57.reg2mem69.0.i.i, 32 ; [#uses=1 type=i1]
...
for.header.i.i.preheader:                         ; preds = %for.header55.i.i
  %row.0.reg2mem.0.i.i = add i32 %indvar57.reg2mem69.0.i.i, %arg_r_offset, !dbg !172 ; [#uses=2 type=i32] [debug line = 11:15]
  %.reg2mem31.0.i.i = mul i32 %row.0.reg2mem.0.i.i, 2724, !dbg !173 ; [#uses=3 type=i32] [debug line = 14:5]
  %tmp.10 = or i32 %.reg2mem31.0.i.i, 1, !dbg !165 ; [#uses=1 type=i32] [debug line = 23:13]
  %tmp.11 = or i32 %.reg2mem31.0.i.i, 2, !dbg !165 ; [#uses=1 type=i32] [debug line = 23:13]
  %tmp.12 = mul nsw i32 %row.0.reg2mem.0.i.i, 55, !dbg !171 ; [#uses=1 type=i32] [debug line = 31:5]
  br label %for.header.i.i

for.header.i.i:                                   ; preds = %._crit_edge.i.i, %for.header.i.i.preheader
  %indvar.reg2mem67.0.i.i = phi i32 [ %indvar.inc.reg2mem.0.i.i, %._crit_edge.i.i ], [ 0, %for.header.i.i.preheader ] ; [#uses=4 type=i32]
  %2 = call i32 (...)* @_ssdm_op_SpecLoopName([13 x i8]* @XCL_WG_DIM_X.str) nounwind ; [#uses=0 type=i32]
  %tmp.13 = icmp eq i32 %indvar.reg2mem67.0.i.i, 32 ; [#uses=1 type=i1]
  br i1 %tmp.13, label %for.body56.i.i, label %.split.i.i
...
.split.i.i:                                       ; preds = %for.header.i.i
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %group_id.load)
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %indvar57.reg2mem69.0.i.i)
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %indvar.reg2mem67.0.i.i)
  %col.0.reg2mem.0.i.i = add i32 %indvar.reg2mem67.0.i.i, %arg_c_offset, !dbg !174 ; [#uses=2 type=i32] [debug line = 12:15]
  %.reg2mem27.0.i.i = mul i32 %col.0.reg2mem.0.i.i, 12, !dbg !175 ; [#uses=3 type=i32] [debug line = 17:5]
  br label %3, !dbg !176                          ; [debug line = 19:18]

; <label>:3                                       ; preds = %5, %.split.i.i
  %i.0.reg2mem45.0.i.i = phi i32 [ 0, %.split.i.i ], [ %.reg2mem5.0.i.i, %5 ] ; [#uses=4 type=i32]
  %product.0.reg2mem47.0.i.i = phi float [ 0.000000e+00, %.split.i.i ], [ %product.1.reg2mem43.0.i.i.lcssa, %5 ] ; [#uses=2 type=float]
  %exitcond5 = icmp eq i32 %i.0.reg2mem45.0.i.i, 11, !dbg !176 ; [#uses=1 type=i1] [debug line = 19:18]
  br i1 %exitcond5, label %._crit_edge.i.i, label %.preheader.preheader, !dbg !176 ; [debug line = 19:18]

.preheader.preheader:                             ; preds = %3
  %tmp.19 = mul i32 %i.0.reg2mem45.0.i.i, 681, !dbg !165 ; [#uses=3 type=i32] [debug line = 23:13]
  %tmp.20 = mul nsw i32 %i.0.reg2mem45.0.i.i, 11, !dbg !165 ; [#uses=3 type=i32] [debug line = 23:13]
  br label %.preheader, !dbg !177                 ; [debug line = 21:22]

.preheader:                                       ; preds = %4, %.preheader.preheader
  %j.0.reg2mem41.0.i.i = phi i32 [ %.reg2mem7.0.i.i, %4 ], [ 0, %.preheader.preheader ] ; [#uses=6 type=i32]
  %product.1.reg2mem43.0.i.i = phi float [ %.reg2mem9.0.i.i, %4 ], [ %product.0.reg2mem47.0.i.i, %.preheader.preheader ] ; [#uses=2 type=float]
  %exitcond = icmp eq i32 %j.0.reg2mem41.0.i.i, 11, !dbg !177 ; [#uses=1 type=i1] [debug line = 21:22]
  br i1 %exitcond, label %5, label %4, !dbg !177  ; [debug line = 21:22]

; <label>:4                                       ; preds = %.preheader
  %tmp.21 = mul nsw i32 %j.0.reg2mem41.0.i.i, 3, !dbg !165 ; [#uses=3 type=i32] [debug line = 23:13]
  %tmp.22 = add i32 %.reg2mem27.0.i.i, %.reg2mem31.0.i.i, !dbg !165 ; [#uses=1 type=i32] [debug line = 23:13]
  %tmp.23 = add i32 %tmp.22, %tmp.19, !dbg !165   ; [#uses=1 type=i32] [debug line = 23:13]
  %tmp.24 = add i32 %tmp.23, %tmp.21, !dbg !165   ; [#uses=1 type=i32] [debug line = 23:13]
  ...
  %tmp.26 = add i32 %tmp.20, %tmp.7, !dbg !165    ; [#uses=1 type=i32] [debug line = 23:13]
  %tmp.27 = add i32 %tmp.26, %j.0.reg2mem41.0.i.i, !dbg !165 ; [#uses=1 type=i32] [debug line = 23:13]
  ...
  %tmp.29 = fmul float %tmp.25, %tmp.28, !dbg !165 ; [#uses=1 type=float] [debug line = 23:13]
  %tmp.30 = add i32 %.reg2mem27.0.i.i, %tmp.10, !dbg !165 ; [#uses=1 type=i32] [debug line = 23:13]
  %tmp.31 = add i32 %tmp.30, %tmp.19, !dbg !165   ; [#uses=1 type=i32] [debug line = 23:13]
  %tmp.32 = add i32 %tmp.31, %tmp.21, !dbg !165   ; [#uses=1 type=i32] [debug line = 23:13]
  ...
  %tmp.34 = add i32 %tmp.7, 121, !dbg !165        ; [#uses=1 type=i32] [debug line = 23:13]
  %tmp.35 = add i32 %tmp.34, %tmp.20, !dbg !165   ; [#uses=1 type=i32] [debug line = 23:13]
  %tmp.36 = add i32 %tmp.35, %j.0.reg2mem41.0.i.i, !dbg !165 ; [#uses=1 type=i32] [debug line = 23:13]
  ...
  %tmp.38 = fmul float %tmp.33, %tmp.37, !dbg !165 ; [#uses=1 type=float] [debug line = 23:13]
  %tmp.39 = fadd float %tmp.29, %tmp.38, !dbg !165 ; [#uses=1 type=float] [debug line = 23:13]
  %tmp.40 = add i32 %.reg2mem27.0.i.i, %tmp.11, !dbg !165 ; [#uses=1 type=i32] [debug line = 23:13]
  %tmp.41 = add i32 %tmp.40, %tmp.19, !dbg !165   ; [#uses=1 type=i32] [debug line = 23:13]
  %tmp.42 = add i32 %tmp.41, %tmp.21, !dbg !165   ; [#uses=1 type=i32] [debug line = 23:13]
  ...
  %tmp.44 = add i32 %tmp.7, 242, !dbg !165        ; [#uses=1 type=i32] [debug line = 23:13]
  %tmp.45 = add i32 %tmp.44, %tmp.20, !dbg !165   ; [#uses=1 type=i32] [debug line = 23:13]
  %tmp.46 = add i32 %tmp.45, %j.0.reg2mem41.0.i.i, !dbg !165 ; [#uses=1 type=i32] [debug line = 23:13]
  ...
  %tmp.48 = fmul float %tmp.43, %tmp.47, !dbg !165 ; [#uses=1 type=float] [debug line = 23:13]
  %tmp.49 = fadd float %tmp.39, %tmp.48, !dbg !165 ; [#uses=1 type=float] [debug line = 23:13]
  %.reg2mem9.0.i.i = fadd float %product.1.reg2mem43.0.i.i, %tmp.49, !dbg !165 ; [#uses=1 type=float] [debug line = 23:13]
  %.reg2mem7.0.i.i = add nsw i32 %j.0.reg2mem41.0.i.i, 1, !dbg !178 ; [#uses=1 type=i32] [debug line = 21:32]
  br label %.preheader, !dbg !178                 ; [debug line = 21:32]

; <label>:5                                       ; preds = %.preheader
  %product.1.reg2mem43.0.i.i.lcssa = phi float [ %product.1.reg2mem43.0.i.i, %.preheader ] ; [#uses=1 type=float]
  %.reg2mem5.0.i.i = add nsw i32 %i.0.reg2mem45.0.i.i, 1, !dbg !179 ; [#uses=1 type=i32] [debug line = 19:28]
  br label %3, !dbg !179                          ; [debug line = 19:28]

._crit_edge.i.i:                                  ; preds = %3
  %product.0.reg2mem47.0.i.i.lcssa = phi float [ %product.0.reg2mem47.0.i.i, %3 ] ; [#uses=1 type=float]
  ...
  %.reg2mem.0.i.i = fadd float %product.0.reg2mem47.0.i.i.lcssa, %tmp.14, !dbg !180 ; [#uses=2 type=float] [debug line = 28:5]
  %tmp.15 = fcmp olt float %.reg2mem.0.i.i, 0.000000e+00, !dbg !181 ; [#uses=1 type=i1] [debug line = 29:5]
  %tmp.16 = add i32 %tmp.12, %tmp.8, !dbg !171    ; [#uses=1 type=i32] [debug line = 31:5]
  %tmp.17 = add i32 %tmp.16, %col.0.reg2mem.0.i.i, !dbg !171 ; [#uses=1 type=i32] [debug line = 31:5]
...
__AESL_call_work_item_NA4.exit:                   ; preds = %for.header55.i.i
  ret void, !dbg !182                             ; [debug line = 81:1]
}
...
!88 = metadata !{i32 786484, i32 0, metadata !81, metadata !"rt_info", metadata !"rt_info", metadata !"", metadata !89, i32 49, metadata !25, i32 1, i32 1, %struct.__spir_rt_info_tT.1.3.7* @rt_info} ; [ DW_TAG_variable ]
...
!129 = metadata !{i32 54, i32 3, metadata !130, null}
!130 = metadata !{i32 786443, metadata !110, metadata !89} ; [ DW_TAG_lexical_block ]
!131 = metadata !{i32 63, i32 3, metadata !130, null}
!132 = metadata !{i32 64, i32 3, metadata !130, null}
!133 = metadata !{i32 65, i32 3, metadata !130, null}
!134 = metadata !{i32 70, i32 3, metadata !130, null}
!135 = metadata !{i32 79, i32 3, metadata !130, null}
!136 = metadata !{i32 88, i32 3, metadata !130, null}
!137 = metadata !{i32 103, i32 3, metadata !130, null}
!138 = metadata !{i32 104, i32 3, metadata !130, null}
!139 = metadata !{i32 105, i32 3, metadata !130, null}
!140 = metadata !{i32 114, i32 3, metadata !130, null}
!141 = metadata !{i32 115, i32 3, metadata !130, null}
!142 = metadata !{i32 116, i32 3, metadata !130, null}
!143 = metadata !{i32 121, i32 3, metadata !130, null}
!144 = metadata !{i32 122, i32 3, metadata !130, null}
!145 = metadata !{i32 123, i32 3, metadata !130, null}
!146 = metadata !{i32 136, i32 3, metadata !130, null}
!147 = metadata !{i32 137, i32 3, metadata !130, null}
!148 = metadata !{i32 138, i32 3, metadata !130, null}
!149 = metadata !{i32 147, i32 3, metadata !130, null}
!150 = metadata !{i32 148, i32 3, metadata !130, null}
!151 = metadata !{i32 149, i32 3, metadata !130, null}
!152 = metadata !{i32 786689, metadata !17, metadata !"gmem", metadata !18, i32 16777268, metadata !21, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!153 = metadata !{i32 52, i32 90, metadata !17, null}
!154 = metadata !{i32 786689, metadata !17, metadata !"args", metadata !18, i32 50331700, metadata !53, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!155 = metadata !{i32 52, i32 149, metadata !17, null}
!156 = metadata !{i32 54, i32 116, metadata !157, null}
!157 = metadata !{i32 786443, metadata !17, i32 53, i32 1, metadata !18, i32 0} ; [ DW_TAG_lexical_block ]
!158 = metadata !{i32 55, i32 144, metadata !157, null}
!159 = metadata !{i32 56, i32 144, metadata !157, null}
!160 = metadata !{i32 57, i32 144, metadata !157, null}
!161 = metadata !{i32 58, i32 45, metadata !157, null}
!162 = metadata !{i32 786688, metadata !157, metadata !"arg_r_offset", metadata !18, i32 58, metadata !23, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!163 = metadata !{i32 59, i32 45, metadata !157, null}
!164 = metadata !{i32 786688, metadata !157, metadata !"arg_c_offset", metadata !18, i32 59, metadata !23, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!165 = metadata !{i32 23, i32 13, metadata !166, null}
!166 = metadata !{i32 786443, metadata !167, i32 22, i32 9, metadata !6, i32 4} ; [ DW_TAG_lexical_block ]
!167 = metadata !{i32 786443, metadata !168, i32 21, i32 9, metadata !6, i32 3} ; [ DW_TAG_lexical_block ]
!168 = metadata !{i32 786443, metadata !169, i32 20, i32 5, metadata !6, i32 2} ; [ DW_TAG_lexical_block ]
!169 = metadata !{i32 786443, metadata !170, i32 19, i32 5, metadata !6, i32 1} ; [ DW_TAG_lexical_block ]
!170 = metadata !{i32 786443, metadata !5, i32 5, i32 1, metadata !6, i32 0} ; [ DW_TAG_lexical_block ]
!171 = metadata !{i32 31, i32 5, metadata !170, null}
!172 = metadata !{i32 11, i32 15, metadata !170, null}
!173 = metadata !{i32 14, i32 5, metadata !170, null}
!174 = metadata !{i32 12, i32 15, metadata !170, null}
!175 = metadata !{i32 17, i32 5, metadata !170, null}
!176 = metadata !{i32 19, i32 18, metadata !169, null}
!177 = metadata !{i32 21, i32 22, metadata !167, null}
!178 = metadata !{i32 21, i32 32, metadata !167, null}
!179 = metadata !{i32 19, i32 28, metadata !169, null}
!180 = metadata !{i32 28, i32 5, metadata !170, null}
!181 = metadata !{i32 29, i32 5, metadata !170, null}
!182 = metadata !{i32 81, i32 1, metadata !183, null}
!183 = metadata !{i32 786443, metadata !110, metadata !18} ; [ DW_TAG_lexical_block ]
