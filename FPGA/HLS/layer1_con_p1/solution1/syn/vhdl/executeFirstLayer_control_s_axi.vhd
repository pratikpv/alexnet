...
entity executeFirstLayer_control_s_axi is
generic (
...
port (
    ...
    Layer1_Neurons_GPU    :out  STD_LOGIC_VECTOR(31 downto 0);
    Layer1_Weights_GPU    :out  STD_LOGIC_VECTOR(31 downto 0);
    Layer2_Neurons_GPU    :out  STD_LOGIC_VECTOR(31 downto 0);
    r_offset              :out  STD_LOGIC_VECTOR(31 downto 0);
    c_offset              :out  STD_LOGIC_VECTOR(31 downto 0)
);
end entity executeFirstLayer_control_s_axi;
...
-- 0x44 : reserved
-- 0x48 : Data signal of r_offset
--        bit 31~0 - r_offset[31:0] (Read/Write)
-- 0x4c : reserved
-- 0x50 : Data signal of c_offset
--        bit 31~0 - c_offset[31:0] (Read/Write)
-- 0x54 : reserved
-- (SC = Self Clear, COR = Clear on Read, TOW = Toggle on Write, COH = Clear on Handshake)

architecture behave of executeFirstLayer_control_s_axi is
    ...
    constant ADDR_LAYER1_NEURONS_GPU_DATA_0 : INTEGER := 16#30#;
    constant ADDR_LAYER1_NEURONS_GPU_CTRL   : INTEGER := 16#34#;
    constant ADDR_LAYER1_WEIGHTS_GPU_DATA_0 : INTEGER := 16#38#;
    constant ADDR_LAYER1_WEIGHTS_GPU_CTRL   : INTEGER := 16#3c#;
    constant ADDR_LAYER2_NEURONS_GPU_DATA_0 : INTEGER := 16#40#;
    constant ADDR_LAYER2_NEURONS_GPU_CTRL   : INTEGER := 16#44#;
    constant ADDR_R_OFFSET_DATA_0           : INTEGER := 16#48#;
    constant ADDR_R_OFFSET_CTRL             : INTEGER := 16#4c#;
    constant ADDR_C_OFFSET_DATA_0           : INTEGER := 16#50#;
    constant ADDR_C_OFFSET_CTRL             : INTEGER := 16#54#;
    ...
    signal int_Layer1_Neurons_GPU : UNSIGNED(31 downto 0);
    signal int_Layer1_Weights_GPU : UNSIGNED(31 downto 0);
    signal int_Layer2_Neurons_GPU : UNSIGNED(31 downto 0);
    signal int_r_offset        : UNSIGNED(31 downto 0);
    signal int_c_offset        : UNSIGNED(31 downto 0);
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_LAYER1_NEURONS_GPU_DATA_0 =>
                        rdata_data <= RESIZE(int_Layer1_Neurons_GPU(31 downto 0), 32);
                    when ADDR_LAYER1_WEIGHTS_GPU_DATA_0 =>
                        rdata_data <= RESIZE(int_Layer1_Weights_GPU(31 downto 0), 32);
                    when ADDR_LAYER2_NEURONS_GPU_DATA_0 =>
                        rdata_data <= RESIZE(int_Layer2_Neurons_GPU(31 downto 0), 32);
                    when ADDR_R_OFFSET_DATA_0 =>
                        rdata_data <= RESIZE(int_r_offset(31 downto 0), 32);
...
-- ----------------------- Register logic ----------------
    ...
    Layer1_Neurons_GPU   <= STD_LOGIC_VECTOR(int_Layer1_Neurons_GPU);
    Layer1_Weights_GPU   <= STD_LOGIC_VECTOR(int_Layer1_Weights_GPU);
    Layer2_Neurons_GPU   <= STD_LOGIC_VECTOR(int_Layer2_Neurons_GPU);
    r_offset             <= STD_LOGIC_VECTOR(int_r_offset);
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_LAYER1_NEURONS_GPU_DATA_0) then
                    int_Layer1_Neurons_GPU(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_Layer1_Neurons_GPU(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_LAYER1_WEIGHTS_GPU_DATA_0) then
                    int_Layer1_Weights_GPU(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_Layer1_Weights_GPU(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_LAYER2_NEURONS_GPU_DATA_0) then
                    int_Layer2_Neurons_GPU(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_Layer2_Neurons_GPU(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_R_OFFSET_DATA_0) then
                    int_r_offset(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_r_offset(31 downto 0));
                end if;
            end if;
        end if;
    end process;
