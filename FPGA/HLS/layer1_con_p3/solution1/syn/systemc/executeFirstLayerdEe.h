...
#ifndef __executeFirstLayerdEe__HH__
#define __executeFirstLayerdEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(executeFirstLayerdEe) {
    ...
    SC_CTOR(executeFirstLayerdEe):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
