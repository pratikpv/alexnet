...
#ifndef __executeFirstLayereOg__HH__
#define __executeFirstLayereOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(executeFirstLayereOg) {
    ...
    SC_CTOR(executeFirstLayereOg):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
