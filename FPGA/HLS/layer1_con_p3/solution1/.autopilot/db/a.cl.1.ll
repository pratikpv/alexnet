; ModuleID = 'C:/Users/RA_prof_Jeon/siddharth/HLS/layer1_con_p3/solution1/.autopilot/db/a.cl.0.bc'
...
%struct.executeFirstLayer1_p3_args_t = type { i32, i32, i32, i32 }
...
; [#uses=0]
define  void @executeFirstLayer1_p3(i32 addrspace(1)* %gmem, %struct.three_tuple_t* %group_id, %struct.executeFirstLayer1_p3_args_t* %args) {
  ...
  call void @llvm.dbg.value(metadata !{%struct.executeFirstLayer1_p3_args_t* %args}, i64 0, metadata !100), !dbg !101 ; [debug line = 59:145] [debug variable = args]
  ...
  call void @llvm.dbg.value(metadata !{%struct.executeFirstLayer1_p3_args_t* %args}, i64 0, metadata !110), !dbg !111 ; [debug line = 34:55@66:1] [debug variable = args]
  %4 = getelementptr inbounds %struct.executeFirstLayer1_p3_args_t* %args, i32 0, i32 0, !dbg !113 ; [#uses=1 type=i32*] [debug line = 35:5@66:1]
  ...
  %5 = getelementptr inbounds %struct.executeFirstLayer1_p3_args_t* %args, i32 0, i32 1, !dbg !115 ; [#uses=1 type=i32*] [debug line = 36:5@66:1]
  ...
  %6 = getelementptr inbounds %struct.executeFirstLayer1_p3_args_t* %args, i32 0, i32 2, !dbg !116 ; [#uses=1 type=i32*] [debug line = 37:5@66:1]
  ...
  %7 = getelementptr inbounds %struct.executeFirstLayer1_p3_args_t* %args, i32 0, i32 3, !dbg !117 ; [#uses=1 type=i32*] [debug line = 38:5@66:1]
  ...
  store i32 32, i32* getelementptr inbounds (%struct.__spir_rt_info_tT.3* @rt_info, i32 0, i32 3, i32 1), align 4, !dbg !129 ; [debug line = 79:3]
  ...
  call void @llvm.dbg.value(metadata !{%struct.executeFirstLayer1_p3_args_t* %args}, i64 0, metadata !151), !dbg !152 ; [debug line = 48:153] [debug variable = args]
  %30 = getelementptr inbounds %struct.executeFirstLayer1_p3_args_t* %args, i32 0, i32 0, !dbg !153 ; [#uses=1 type=i32*] [debug line = 50:116]
  ...
  %33 = getelementptr inbounds %struct.executeFirstLayer1_p3_args_t* %args, i32 0, i32 1, !dbg !156 ; [#uses=1 type=i32*] [debug line = 51:144]
  ...
  %36 = getelementptr inbounds %struct.executeFirstLayer1_p3_args_t* %args, i32 0, i32 2, !dbg !158 ; [#uses=1 type=i32*] [debug line = 52:144]
  ...
  %39 = getelementptr inbounds %struct.executeFirstLayer1_p3_args_t* %args, i32 0, i32 3, !dbg !160 ; [#uses=1 type=i32*] [debug line = 53:144]
...
for.header57.i.i:                                 ; preds = %for.body58.i.i, %0
  ...
  %145 = icmp eq i32 %indvar59.reg2mem71.0.i.i, 32 ; [#uses=1 type=i1]
...
for.header.i.i:                                   ; preds = %._crit_edge.i.i, %for.header57.i.i
  ...
  %147 = icmp eq i32 %indvar.reg2mem69.0.i.i, 23  ; [#uses=1 type=i1]
...
.split.i.i:                                       ; preds = %for.header.i.i
  ...
  %row.0.reg2mem.0.i.i = add i32 %tid.dim.i.i, 32, !dbg !162 ; [#uses=2 type=i32] [debug line = 15:15]
  %.reg2mem35.0.i.i = load i32* %tid73.sub.i.i, align 4 ; [#uses=2 type=i32]
  %.reg2mem31.0.i.i = mul i32 %row.0.reg2mem.0.i.i, 2724, !dbg !164 ; [#uses=3 type=i32] [debug line = 18:5]
  %.reg2mem27.0.i.i = mul i32 %.reg2mem35.0.i.i, 12, !dbg !165 ; [#uses=3 type=i32] [debug line = 21:5]
  br label %149, !dbg !166                        ; [debug line = 23:18]
...
; <label>:149                                     ; preds = %208, %.split.i.i
  ...
  %150 = icmp slt i32 %i.0.reg2mem47.0.i.i, 11, !dbg !166 ; [#uses=1 type=i1] [debug line = 23:18]
  br i1 %150, label %151, label %._crit_edge.i.i, !dbg !166 ; [debug line = 23:18]
...
; <label>:151                                     ; preds = %153, %149
  ...
  %152 = icmp slt i32 %j.0.reg2mem43.0.i.i, 11, !dbg !168 ; [#uses=1 type=i1] [debug line = 25:22]
  br i1 %152, label %153, label %208, !dbg !168   ; [debug line = 25:22]

; <label>:153                                     ; preds = %151
  %154 = mul i32 %i.0.reg2mem47.0.i.i, 681, !dbg !171 ; [#uses=1 type=i32] [debug line = 27:13]
  %155 = mul nsw i32 %j.0.reg2mem43.0.i.i, 3, !dbg !171 ; [#uses=1 type=i32] [debug line = 27:13]
  %156 = add nsw i32 %154, %155, !dbg !171        ; [#uses=1 type=i32] [debug line = 27:13]
  %157 = add nsw i32 %156, %.reg2mem27.0.i.i, !dbg !171 ; [#uses=1 type=i32] [debug line = 27:13]
  %158 = add nsw i32 %157, %.reg2mem31.0.i.i, !dbg !171 ; [#uses=1 type=i32] [debug line = 27:13]
  ...
  %162 = mul nsw i32 %i.0.reg2mem47.0.i.i, 11, !dbg !171 ; [#uses=1 type=i32] [debug line = 27:13]
  %163 = add nsw i32 %162, %j.0.reg2mem43.0.i.i, !dbg !171 ; [#uses=1 type=i32] [debug line = 27:13]
  %164 = mul i32 %output.0.reg2mem.0.i.i, 363, !dbg !171 ; [#uses=1 type=i32] [debug line = 27:13]
  %165 = add nsw i32 %163, %164, !dbg !171        ; [#uses=1 type=i32] [debug line = 27:13]
  ...
  %169 = fmul float %161, %168, !dbg !171         ; [#uses=1 type=float] [debug line = 27:13]
  %170 = mul i32 %i.0.reg2mem47.0.i.i, 681, !dbg !171 ; [#uses=1 type=i32] [debug line = 27:13]
  %171 = mul nsw i32 %j.0.reg2mem43.0.i.i, 3, !dbg !171 ; [#uses=1 type=i32] [debug line = 27:13]
  %172 = add nsw i32 %170, %171, !dbg !171        ; [#uses=1 type=i32] [debug line = 27:13]
  %173 = add nsw i32 %172, 1, !dbg !171           ; [#uses=1 type=i32] [debug line = 27:13]
  %174 = add nsw i32 %173, %.reg2mem27.0.i.i, !dbg !171 ; [#uses=1 type=i32] [debug line = 27:13]
  %175 = add nsw i32 %174, %.reg2mem31.0.i.i, !dbg !171 ; [#uses=1 type=i32] [debug line = 27:13]
  ...
  %179 = mul nsw i32 %i.0.reg2mem47.0.i.i, 11, !dbg !171 ; [#uses=1 type=i32] [debug line = 27:13]
  %180 = add nsw i32 %179, 121, !dbg !171         ; [#uses=1 type=i32] [debug line = 27:13]
  %181 = add nsw i32 %180, %j.0.reg2mem43.0.i.i, !dbg !171 ; [#uses=1 type=i32] [debug line = 27:13]
  %182 = mul i32 %output.0.reg2mem.0.i.i, 363, !dbg !171 ; [#uses=1 type=i32] [debug line = 27:13]
  %183 = add nsw i32 %181, %182, !dbg !171        ; [#uses=1 type=i32] [debug line = 27:13]
  ...
  %187 = fmul float %178, %186, !dbg !171         ; [#uses=1 type=float] [debug line = 27:13]
  %188 = fadd float %169, %187, !dbg !171         ; [#uses=1 type=float] [debug line = 27:13]
  %189 = mul i32 %i.0.reg2mem47.0.i.i, 681, !dbg !171 ; [#uses=1 type=i32] [debug line = 27:13]
  %190 = mul nsw i32 %j.0.reg2mem43.0.i.i, 3, !dbg !171 ; [#uses=1 type=i32] [debug line = 27:13]
  %191 = add nsw i32 %189, %190, !dbg !171        ; [#uses=1 type=i32] [debug line = 27:13]
  %192 = add nsw i32 %191, 2, !dbg !171           ; [#uses=1 type=i32] [debug line = 27:13]
  %193 = add nsw i32 %192, %.reg2mem27.0.i.i, !dbg !171 ; [#uses=1 type=i32] [debug line = 27:13]
  %194 = add nsw i32 %193, %.reg2mem31.0.i.i, !dbg !171 ; [#uses=1 type=i32] [debug line = 27:13]
  ...
  %198 = mul nsw i32 %i.0.reg2mem47.0.i.i, 11, !dbg !171 ; [#uses=1 type=i32] [debug line = 27:13]
  %199 = add nsw i32 %198, 242, !dbg !171         ; [#uses=1 type=i32] [debug line = 27:13]
  %200 = add nsw i32 %199, %j.0.reg2mem43.0.i.i, !dbg !171 ; [#uses=1 type=i32] [debug line = 27:13]
  %201 = mul i32 %output.0.reg2mem.0.i.i, 363, !dbg !171 ; [#uses=1 type=i32] [debug line = 27:13]
  %202 = add nsw i32 %200, %201, !dbg !171        ; [#uses=1 type=i32] [debug line = 27:13]
  ...
  %206 = fmul float %197, %205, !dbg !171         ; [#uses=1 type=float] [debug line = 27:13]
  %207 = fadd float %188, %206, !dbg !171         ; [#uses=1 type=float] [debug line = 27:13]
  %.reg2mem9.0.i.i = fadd float %product.1.reg2mem45.0.i.i, %207, !dbg !171 ; [#uses=1 type=float] [debug line = 27:13]
  %.reg2mem7.0.i.i = add nsw i32 %j.0.reg2mem43.0.i.i, 1, !dbg !173 ; [#uses=1 type=i32] [debug line = 25:32]
  br label %151, !dbg !173                        ; [debug line = 25:32]

; <label>:208                                     ; preds = %151
  %.reg2mem5.0.i.i = add nsw i32 %i.0.reg2mem47.0.i.i, 1, !dbg !174 ; [#uses=1 type=i32] [debug line = 23:28]
  br label %149, !dbg !174                        ; [debug line = 23:28]
...
._crit_edge.i.i:                                  ; preds = %149
  ...
  %.reg2mem.0.i.i = fadd float %product.0.reg2mem49.0.i.i, %211, !dbg !175 ; [#uses=2 type=float] [debug line = 32:5]
  %212 = fcmp olt float %.reg2mem.0.i.i, 0.000000e+00, !dbg !176 ; [#uses=1 type=i1] [debug line = 33:5]
  %product.2.reg2mem.0.i.i = select i1 %212, float 0.000000e+00, float %.reg2mem.0.i.i, !dbg !176 ; [#uses=1 type=float] [debug line = 33:5]
  %213 = mul i32 %output.0.reg2mem.0.i.i, 3025, !dbg !177 ; [#uses=1 type=i32] [debug line = 35:5]
  %214 = mul nsw i32 %row.0.reg2mem.0.i.i, 55, !dbg !177 ; [#uses=1 type=i32] [debug line = 35:5]
  %215 = add nsw i32 %213, %214, !dbg !177        ; [#uses=1 type=i32] [debug line = 35:5]
  %216 = add nsw i32 %215, %.reg2mem35.0.i.i, !dbg !177 ; [#uses=1 type=i32] [debug line = 35:5]
...
__AESL_call_work_item_NA4.exit:                   ; preds = %for.header57.i.i
  %220 = bitcast [3 x i32]* %tid73.i.i to i8*, !dbg !178 ; [#uses=0 type=i8*] [debug line = 37:1]
...
!163 = metadata !{i32 786443, metadata !5, i32 5, i32 1, metadata !6, i32 0} ; [ DW_TAG_lexical_block ]
!164 = metadata !{i32 18, i32 5, metadata !163, null}
!165 = metadata !{i32 21, i32 5, metadata !163, null}
!166 = metadata !{i32 23, i32 18, metadata !167, null}
!167 = metadata !{i32 786443, metadata !163, i32 23, i32 5, metadata !6, i32 1} ; [ DW_TAG_lexical_block ]
!168 = metadata !{i32 25, i32 22, metadata !169, null}
!169 = metadata !{i32 786443, metadata !170, i32 25, i32 9, metadata !6, i32 3} ; [ DW_TAG_lexical_block ]
!170 = metadata !{i32 786443, metadata !167, i32 24, i32 5, metadata !6, i32 2} ; [ DW_TAG_lexical_block ]
!171 = metadata !{i32 27, i32 13, metadata !172, null}
!172 = metadata !{i32 786443, metadata !169, i32 26, i32 9, metadata !6, i32 4} ; [ DW_TAG_lexical_block ]
!173 = metadata !{i32 25, i32 32, metadata !169, null}
!174 = metadata !{i32 23, i32 28, metadata !167, null}
!175 = metadata !{i32 32, i32 5, metadata !163, null}
!176 = metadata !{i32 33, i32 5, metadata !163, null}
!177 = metadata !{i32 35, i32 5, metadata !163, null}
!178 = metadata !{i32 37, i32 1, metadata !163, null}
