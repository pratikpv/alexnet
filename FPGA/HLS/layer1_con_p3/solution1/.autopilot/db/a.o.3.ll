; ModuleID = 'C:/Users/RA_prof_Jeon/siddharth/HLS/layer1_con_p3/solution1/.autopilot/db/a.o.3.bc'
target datalayout = "e-p:32:32:32-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v16:16:16-v24:32:32-v32:32:32-v48:64:64-v64:64:64-v96:128:128-v128:128:128-v192:256:256-v256:256:256-v512:512:512-v1024:1024:1024"
target triple = "spir-unknown-linux-gnu"

@executeFirstLayer1_p = internal unnamed_addr constant [22 x i8] c"executeFirstLayer1_p3\00" ; [#uses=1 type=[22 x i8]*]
...
define void @executeFirstLayer1_p3(i32 addrspace(1)* %gmem, i32* %group_id_x, i32* %group_id_y, i32* %group_id_z, i32* %bias, i32* %Layer1_Neurons_GPU, i32* %Layer1_Weights_GPU, i32* %Layer2_Neurons_GPU) {
  ...
  %tmp_4 = call i30 @_ssdm_op_PartSelect.i30.i32.i32.i32(i32 %Layer2_Neurons_GPU_r, i32 2, i32 31), !dbg !195 ; [#uses=1 type=i30] [debug line = 27:13]
  %tmp_5_cast = zext i30 %tmp_4 to i31, !dbg !195 ; [#uses=1 type=i31] [debug line = 27:13]
  ...
  %tmp_s = mul i30 363, %tmp_6, !dbg !195         ; [#uses=2 type=i30] [debug line = 27:13]
  %tmp_5 = mul i30 3025, %tmp_6, !dbg !207        ; [#uses=1 type=i30] [debug line = 35:5]
...
for.header.i.i:                                   ; preds = %._crit_edge.i.i, %0
  ...
  %indvar59_reg2mem71 = phi i6 [ 0, %0 ], [ %indvar59_reg2mem71_0_1, %._crit_edge.i.i ] ; [#uses=4 type=i6]
  %indvar_reg2mem69_0_i = phi i5 [ 0, %0 ], [ %indvar_inc_reg2mem, %._crit_edge.i.i ] ; [#uses=2 type=i5]
  %exitcond_flatten = icmp eq i10 %indvar_flatten, -288 ; [#uses=1 type=i1]
...
for.body58.i.i:                                   ; preds = %for.header.i.i
  ...
  %empty_4 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 736, i64 736, i64 736) ; [#uses=0 type=i32]
  %tmp_9 = icmp eq i5 %indvar_reg2mem69_0_i, -9   ; [#uses=3 type=i1]
  %indvar_reg2mem69_0_i_1 = select i1 %tmp_9, i5 0, i5 %indvar_reg2mem69_0_i ; [#uses=4 type=i5]
  %row_0_reg2mem_0_i_i_s = add i6 %indvar59_reg2mem71, -31, !dbg !208 ; [#uses=1 type=i6] [debug line = 15:15]
  %row_0_reg2mem_0_i_i5 = xor i6 %indvar59_reg2mem71, -32, !dbg !208 ; [#uses=1 type=i6] [debug line = 15:15]
  %p_reg2mem31_0_i_i_mid = select i1 %tmp_9, i6 %row_0_reg2mem_0_i_i_s, i6 %row_0_reg2mem_0_i_i5, !dbg !209 ; [#uses=2 type=i6] [debug line = 18:5]
  %p_reg2mem31_0_i_i_mid_1 = zext i6 %p_reg2mem31_0_i_i_mid to i18, !dbg !209 ; [#uses=1 type=i18] [debug line = 18:5]
  %p_reg2mem31_0_i_i_mid_2 = mul i18 %p_reg2mem31_0_i_i_mid_1, 2724, !dbg !209 ; [#uses=3 type=i18] [debug line = 18:5]
  %tmp_cast_mid2_v = or i18 %p_reg2mem31_0_i_i_mid_2, 1, !dbg !195 ; [#uses=1 type=i18] [debug line = 27:13]
  %tmp_cast_mid2 = zext i18 %tmp_cast_mid2_v to i20, !dbg !195 ; [#uses=1 type=i20] [debug line = 27:13]
  %tmp_1_cast_mid2_v = or i18 %p_reg2mem31_0_i_i_mid_2, 2, !dbg !195 ; [#uses=1 type=i18] [debug line = 27:13]
  %tmp_1_cast_mid2 = zext i18 %tmp_1_cast_mid2_v to i20, !dbg !195 ; [#uses=1 type=i20] [debug line = 27:13]
  %tmp_28_mid2_v_v = zext i6 %p_reg2mem31_0_i_i_mid to i13, !dbg !207 ; [#uses=1 type=i13] [debug line = 35:5]
  %tmp_28_mid2_v = mul i13 %tmp_28_mid2_v_v, 55, !dbg !207 ; [#uses=1 type=i13] [debug line = 35:5]
  %tmp_28_mid2 = zext i13 %tmp_28_mid2_v to i30, !dbg !207 ; [#uses=1 type=i30] [debug line = 35:5]
  %indvar_inc60_reg2mem = add i6 %indvar59_reg2mem71, 1 ; [#uses=1 type=i6]
  %indvar59_reg2mem71_0_1 = select i1 %tmp_9, i6 %indvar_inc60_reg2mem, i6 %indvar59_reg2mem71 ; [#uses=1 type=i6]
  %empty_5 = call i32 (...)* @_ssdm_op_SpecLoopName([13 x i8]* @XCL_WG_DIM_X_str) nounwind ; [#uses=0 type=i32]
  %p_shl = call i9 @_ssdm_op_BitConcatenate.i9.i5.i4(i5 %indvar_reg2mem69_0_i_1, i4 0), !dbg !210 ; [#uses=1 type=i9] [debug line = 21:5]
  %p_shl_cast = zext i9 %p_shl to i10, !dbg !210  ; [#uses=1 type=i10] [debug line = 21:5]
  %p_shl1 = call i7 @_ssdm_op_BitConcatenate.i7.i5.i2(i5 %indvar_reg2mem69_0_i_1, i2 0), !dbg !210 ; [#uses=1 type=i7] [debug line = 21:5]
  %p_shl1_cast = zext i7 %p_shl1 to i10, !dbg !210 ; [#uses=1 type=i10] [debug line = 21:5]
  %p_reg2mem27_0_i_i = sub i10 %p_shl_cast, %p_shl1_cast, !dbg !210 ; [#uses=2 type=i10] [debug line = 21:5]
  %p_reg2mem27_0_i_i_cas = sext i10 %p_reg2mem27_0_i_i to i20, !dbg !210 ; [#uses=2 type=i20] [debug line = 21:5]
  %p_reg2mem27_0_i_i_cas_1 = sext i10 %p_reg2mem27_0_i_i to i18, !dbg !210 ; [#uses=1 type=i18] [debug line = 21:5]
  %tmp = add i18 %p_reg2mem27_0_i_i_cas_1, %p_reg2mem31_0_i_i_mid_2, !dbg !195 ; [#uses=1 type=i18] [debug line = 27:13]
  %tmp3 = add i20 %p_reg2mem27_0_i_i_cas, %tmp_cast_mid2, !dbg !195 ; [#uses=1 type=i20] [debug line = 27:13]
  %tmp7 = add i20 %p_reg2mem27_0_i_i_cas, %tmp_1_cast_mid2, !dbg !195 ; [#uses=1 type=i20] [debug line = 27:13]
  br label %.loopexit, !dbg !211                  ; [debug line = 23:18]

.loopexit.loopexit:                               ; preds = %.preheader
  br label %.loopexit

.loopexit:                                        ; preds = %.loopexit.loopexit, %for.body58.i.i
  %i_0_reg2mem47_0_i_i = phi i4 [ 0, %for.body58.i.i ], [ %p_reg2mem5_0_i_i, %.loopexit.loopexit ] ; [#uses=2 type=i4]
  %product_0_reg2mem49_s = phi float [ 0.000000e+00, %for.body58.i.i ], [ %product_1_reg2mem45_s, %.loopexit.loopexit ] ; [#uses=2 type=float]
  %phi_mul = phi i13 [ 0, %for.body58.i.i ], [ %next_mul, %.loopexit.loopexit ] ; [#uses=2 type=i13]
  %phi_mul2 = phi i7 [ 0, %for.body58.i.i ], [ %next_mul3, %.loopexit.loopexit ] ; [#uses=3 type=i7]
  ...
  %exitcond5 = icmp eq i4 %i_0_reg2mem47_0_i_i, -5, !dbg !211 ; [#uses=1 type=i1] [debug line = 23:18]
  %empty_6 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 11, i64 11, i64 11) ; [#uses=0 type=i32]
  %p_reg2mem5_0_i_i = add i4 %i_0_reg2mem47_0_i_i, 1, !dbg !212 ; [#uses=1 type=i4] [debug line = 23:28]
  br i1 %exitcond5, label %._crit_edge.i.i, label %.preheader.preheader, !dbg !211 ; [debug line = 23:18]

.preheader.preheader:                             ; preds = %.loopexit
  %tmp_16 = zext i7 %phi_mul2 to i30, !dbg !195   ; [#uses=1 type=i30] [debug line = 27:13]
  %tmp_17 = add i30 %tmp_16, %tmp_s, !dbg !195    ; [#uses=2 type=i30] [debug line = 27:13]
  br label %.preheader, !dbg !213                 ; [debug line = 25:22]

.preheader:                                       ; preds = %1, %.preheader.preheader
  %j_0_reg2mem43_0_i_i = phi i4 [ %p_reg2mem7_0_i_i, %1 ], [ 0, %.preheader.preheader ] ; [#uses=6 type=i4]
  %product_1_reg2mem45_s = phi float [ %p_reg2mem9_0_i_i, %1 ], [ %product_0_reg2mem49_s, %.preheader.preheader ] ; [#uses=2 type=float]
  %j_0_reg2mem43_0_i_i_s = zext i4 %j_0_reg2mem43_0_i_i to i8, !dbg !213 ; [#uses=1 type=i8] [debug line = 25:22]
  %j_0_reg2mem43_0_i_i_1 = zext i4 %j_0_reg2mem43_0_i_i to i5, !dbg !213 ; [#uses=1 type=i5] [debug line = 25:22]
  %j_0_reg2mem43_0_i_i_2 = zext i4 %j_0_reg2mem43_0_i_i to i7, !dbg !213 ; [#uses=2 type=i7] [debug line = 25:22]
  %exitcond = icmp eq i4 %j_0_reg2mem43_0_i_i, -5, !dbg !213 ; [#uses=1 type=i1] [debug line = 25:22]
  %empty_7 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 11, i64 11, i64 11) ; [#uses=0 type=i32]
  %p_reg2mem7_0_i_i = add i4 %j_0_reg2mem43_0_i_i, 1, !dbg !214 ; [#uses=1 type=i4] [debug line = 25:32]
  br i1 %exitcond, label %.loopexit.loopexit, label %1, !dbg !213 ; [debug line = 25:22]

; <label>:1                                       ; preds = %.preheader
  %p_shl2 = call i6 @_ssdm_op_BitConcatenate.i6.i4.i2(i4 %j_0_reg2mem43_0_i_i, i2 0), !dbg !195 ; [#uses=1 type=i6] [debug line = 27:13]
  %p_shl2_cast = zext i6 %p_shl2 to i7, !dbg !195 ; [#uses=1 type=i7] [debug line = 27:13]
  %tmp_18 = sub i7 %p_shl2_cast, %j_0_reg2mem43_0_i_i_2, !dbg !195 ; [#uses=1 type=i7] [debug line = 27:13]
  %tmp_18_cast = sext i7 %tmp_18 to i14, !dbg !195 ; [#uses=1 type=i14] [debug line = 27:13]
  %tmp1 = add i14 %tmp_18_cast, %phi_mul_cast, !dbg !195 ; [#uses=2 type=i14] [debug line = 27:13]
  %tmp1_cast = sext i14 %tmp1 to i18, !dbg !195   ; [#uses=1 type=i18] [debug line = 27:13]
  %tmp_19 = add i18 %tmp, %tmp1_cast, !dbg !195   ; [#uses=1 type=i18] [debug line = 27:13]
  ...
  %tmp2 = add i7 %j_0_reg2mem43_0_i_i_2, %phi_mul2, !dbg !195 ; [#uses=1 type=i7] [debug line = 27:13]
  %tmp_21 = zext i7 %tmp2 to i30, !dbg !195       ; [#uses=1 type=i30] [debug line = 27:13]
  %tmp_24_cast = add i30 %tmp_s, %tmp_21, !dbg !195 ; [#uses=1 type=i30] [debug line = 27:13]
  ...
  %tmp_23 = fmul float %tmp_20, %tmp_22, !dbg !195 ; [#uses=1 type=float] [debug line = 27:13]
  %tmp4_cast = sext i14 %tmp1 to i20, !dbg !195   ; [#uses=2 type=i20] [debug line = 27:13]
  %tmp_24 = add i20 %tmp3, %tmp4_cast, !dbg !195  ; [#uses=1 type=i20] [debug line = 27:13]
  %gep_idx36_i_i_cast1 = sext i20 %tmp_24 to i30  ; [#uses=1 type=i30]
  %gep_idx36_i_i_cast = zext i30 %gep_idx36_i_i_cast1 to i31 ; [#uses=1 type=i31]
  ...
  %tmp6 = add i8 %j_0_reg2mem43_0_i_i_s, 121, !dbg !195 ; [#uses=1 type=i8] [debug line = 27:13]
  %tmp_26 = zext i8 %tmp6 to i30, !dbg !195       ; [#uses=1 type=i30] [debug line = 27:13]
  %tmp_33_cast = add i30 %tmp_17, %tmp_26, !dbg !195 ; [#uses=1 type=i30] [debug line = 27:13]
  ...
  %tmp_28 = fmul float %tmp_25, %tmp_27, !dbg !195 ; [#uses=1 type=float] [debug line = 27:13]
  %tmp_29 = fadd float %tmp_23, %tmp_28, !dbg !195 ; [#uses=1 type=float] [debug line = 27:13]
  %tmp_30 = add i20 %tmp7, %tmp4_cast, !dbg !195  ; [#uses=1 type=i20] [debug line = 27:13]
  %gep_idx52_i_i_cast1 = sext i20 %tmp_30 to i30  ; [#uses=1 type=i30]
  %gep_idx52_i_i_cast = zext i30 %gep_idx52_i_i_cast1 to i31 ; [#uses=1 type=i31]
  ...
  %tmp5 = add i5 %j_0_reg2mem43_0_i_i_1, -14, !dbg !195 ; [#uses=1 type=i5] [debug line = 27:13]
  %tmp10_cast = sext i5 %tmp5 to i8, !dbg !195    ; [#uses=1 type=i8] [debug line = 27:13]
  %tmp_32 = zext i8 %tmp10_cast to i30, !dbg !195 ; [#uses=1 type=i30] [debug line = 27:13]
  %tmp_43_cast = add i30 %tmp_17, %tmp_32, !dbg !195 ; [#uses=1 type=i30] [debug line = 27:13]
  ...
  %tmp_34 = fmul float %tmp_31, %tmp_33, !dbg !195 ; [#uses=1 type=float] [debug line = 27:13]
  %tmp_35 = fadd float %tmp_29, %tmp_34, !dbg !195 ; [#uses=1 type=float] [debug line = 27:13]
  %p_reg2mem9_0_i_i = fadd float %product_1_reg2mem45_s, %tmp_35, !dbg !195 ; [#uses=1 type=float] [debug line = 27:13]
  br label %.preheader, !dbg !214                 ; [debug line = 25:32]
...
._crit_edge.i.i:                                  ; preds = %.loopexit
  ...
  %p_reg2mem_0_i_i = fadd float %product_0_reg2mem49_s, %tmp_7, !dbg !215 ; [#uses=2 type=float] [debug line = 32:5]
  ...
  %tmp_11 = fcmp olt float %p_reg2mem_0_i_i, 0.000000e+00, !dbg !216 ; [#uses=1 type=i1] [debug line = 33:5]
  %tmp_12 = and i1 %tmp_10, %tmp_11, !dbg !216    ; [#uses=1 type=i1] [debug line = 33:5]
  %tmp_13 = zext i5 %indvar_reg2mem69_0_i_1 to i30, !dbg !207 ; [#uses=1 type=i30] [debug line = 35:5]
  %tmp_14 = add i30 %tmp_5, %tmp_13, !dbg !207    ; [#uses=1 type=i30] [debug line = 35:5]
  %tmp_14_cast = add i30 %tmp_14, %tmp_28_mid2, !dbg !207 ; [#uses=1 type=i30] [debug line = 35:5]
  ...
  %indvar_inc_reg2mem = add i5 1, %indvar_reg2mem69_0_i_1 ; [#uses=1 type=i5]
  br label %for.header.i.i

__AESL_call_work_item_NA4.exit:                   ; preds = %for.header.i.i
  ret void, !dbg !217                             ; [debug line = 75:1]
}
...
entry:
  ...
  %empty_13 = zext i2 %1 to i7                    ; [#uses=1 type=i7]
  %empty_14 = shl i7 %empty, 2                    ; [#uses=1 type=i7]
...
!60 = metadata !{i32 786473, metadata !"executeFirstLayer1_p3_compute_unit", metadata !"C:\5CUsers\5CRA_prof_Jeon\5Csiddharth\5CHLS\5Clayer1_con_p3\5Csolution1\5C.autopilot\5Cdb", null} ; [ DW_TAG_file_type ]
...
!85 = metadata !{i32 786454, null, metadata !"executeFirstLayer1_p3_args_t", metadata !60, i32 23, i64 0, i64 0, i64 0, i32 0, metadata !86} ; [ DW_TAG_typedef ]
...
!149 = metadata !{i32 786473, metadata !"C:/Xilinx/Vivado_HLS/2016.4/common/technology/autopilot/opencl\5Caesl_gen_cu_body.inc", metadata !"C:\5CUsers\5CRA_prof_Jeon\5Csiddharth\5CHLS\5Clayer1_con_p3\5Csolution1\5C.autopilot\5Cdb", null} ; [ DW_TAG_file_type ]
...
!157 = metadata !{i32 786473, metadata !"C:/Xilinx/Vivado_HLS/2016.4/common/technology/autopilot/opencl/libspir_types.h", metadata !"C:\5CUsers\5CRA_prof_Jeon\5Csiddharth\5CHLS\5Clayer1_con_p3\5Csolution1\5C.autopilot\5Cdb", null} ; [ DW_TAG_file_type ]
...
!195 = metadata !{i32 27, i32 13, metadata !196, null}
!196 = metadata !{i32 786443, metadata !197, i32 26, i32 9, metadata !202, i32 4} ; [ DW_TAG_lexical_block ]
!197 = metadata !{i32 786443, metadata !198, i32 25, i32 9, metadata !202, i32 3} ; [ DW_TAG_lexical_block ]
!198 = metadata !{i32 786443, metadata !199, i32 24, i32 5, metadata !202, i32 2} ; [ DW_TAG_lexical_block ]
!199 = metadata !{i32 786443, metadata !200, i32 23, i32 5, metadata !202, i32 1} ; [ DW_TAG_lexical_block ]
!200 = metadata !{i32 786443, metadata !201, i32 5, i32 1, metadata !202, i32 0} ; [ DW_TAG_lexical_block ]
!201 = metadata !{i32 786478, i32 0, metadata !202, metadata !"executeFirstLayer1_p3", metadata !"executeFirstLayer1_p3", metadata !"", metadata !202, i32 3, metadata !203, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, null, metadata !79, i32 5} ; [ DW_TAG_subprogram ]
!202 = metadata !{i32 786473, metadata !"layer1_con_p3/executeFirstLayer1_p3.cl", metadata !"C:\5CUsers\5CRA_prof_Jeon\5Csiddharth\5CHLS", null} ; [ DW_TAG_file_type ]
...
!207 = metadata !{i32 35, i32 5, metadata !200, null}
!208 = metadata !{i32 15, i32 15, metadata !200, null}
!209 = metadata !{i32 18, i32 5, metadata !200, null}
!210 = metadata !{i32 21, i32 5, metadata !200, null}
!211 = metadata !{i32 23, i32 18, metadata !199, null}
!212 = metadata !{i32 23, i32 28, metadata !199, null}
!213 = metadata !{i32 25, i32 22, metadata !197, null}
!214 = metadata !{i32 25, i32 32, metadata !197, null}
!215 = metadata !{i32 32, i32 5, metadata !200, null}
!216 = metadata !{i32 33, i32 5, metadata !200, null}
!217 = metadata !{i32 75, i32 1, metadata !218, null}
!218 = metadata !{i32 786443, metadata !132, metadata !60} ; [ DW_TAG_lexical_block ]
