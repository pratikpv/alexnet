...
set out_width 18
set exp i0*i1
set arg_lists {i0 {6 0 +} i1 {13 0 +} p {18 0 +} }
if {${::AESL::PGuard_simmodel_gen}} {
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 4 \
			corename executeFirstLayer1_p3_control_axilite \
			name executeFirstLayer1_p3_control_s_axi \
			ports {$port_control} \
			op interface \
		} "
	} else {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler executeFirstLayer1_p3_control_s_axi
}
...
eval "::AESL_LIB_XILADAPTER::m_axi_gen { \
    ...
    max_latency -1 \ 
    delay_budget 8.75 \ 
    name {executeFirstLayer1_p3_gmem_m_axi} \
} "
} else {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler executeFirstLayer1_p3_gmem_m_axi
}
