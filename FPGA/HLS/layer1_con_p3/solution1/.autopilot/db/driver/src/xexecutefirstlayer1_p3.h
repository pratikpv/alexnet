...
#ifndef XEXECUTEFIRSTLAYER1_P3_H
#define XEXECUTEFIRSTLAYER1_P3_H
...
#include <stddef.h>
#endif
#include "xexecutefirstlayer1_p3_hw.h"
...
} XExecutefirstlayer1_p3_Config;
#endif

typedef struct {
    u32 Control_BaseAddress;
    u32 IsReady;
} XExecutefirstlayer1_p3;

/***************** Macros (Inline Functions) Definitions *********************/
#ifndef __linux__
#define XExecutefirstlayer1_p3_WriteReg(BaseAddress, RegOffset, Data) \
    Xil_Out32((BaseAddress) + (RegOffset), (u32)(Data))
#define XExecutefirstlayer1_p3_ReadReg(BaseAddress, RegOffset) \
